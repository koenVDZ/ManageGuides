...
* @subpackage	Classes
*/
class GuideadmCkModelContact extends GuideadmClassModelItem
{
	/**
	...
	*/
	public function getTable($type = 'contact', $prefix = 'GuideadmTable', $config = array())
	{
	...
	*/
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_guideadm.edit.contact.data', array());
	...
	*/
	public function save($data)
	{
		...
		$data['birthdate'] = GuideadmHelperDates::getSqlDate($data['birthdate'], array('d-m-Y'), true, 'USER_UTC');
...
if (!class_exists('GuideadmModelContact')){ class GuideadmModelContact extends GuideadmCkModelContact{} }
