...
* @subpackage	Classes
*/
class GuideadmCkModelThirdusers extends GuideadmClassModelList
{
	/**
	* Default item layout.
	*
	...
	*/
	...
	{
		$item->section = JText::_('GUIDEADM') . ' - ' . JText::_('GUIDEADM_VIEW_USER');
...
if (!class_exists('GuideadmModelThirdusers')){ class GuideadmModelThirdusers extends GuideadmCkModelThirdusers{} }
