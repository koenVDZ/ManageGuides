...
* @subpackage	Classes
*/
class GuideadmCkModelCountries extends GuideadmClassModelList
{
	/**
	* Default item layout.
	*
	...
	*/
	...
	{
		$item->section = JText::_('GUIDEADM') . ' - ' . JText::_('GUIDEADM_VIEW_COUNTRY');
...
if (!class_exists('GuideadmModelCountries')){ class GuideadmModelCountries extends GuideadmCkModelCountries{} }
