...
* @subpackage	Classes
*/
class GuideadmCkModelPhonelabels extends GuideadmClassModelList
{
	/**
	* Default item layout.
	*
	...
	*/
	...
	{
		$item->section = JText::_('GUIDEADM') . ' - ' . JText::_('GUIDEADM_VIEW_PHONE_LABELS_ITEM');
...
if (!class_exists('GuideadmModelPhonelabels')){ class GuideadmModelPhonelabels extends GuideadmCkModelPhonelabels{} }
