...
* @subpackage	Classes
*/
class GuideadmCkModelCategories extends GuideadmClassModelList
{
	/**
	* Default item layout.
	*
	...
	*/
	...
	{
		$item->section = JText::_('GUIDEADM') . ' - ' . JText::_('GUIDEADM_VIEW_CATEGORIES');
...
if (!class_exists('GuideadmModelCategories')){ class GuideadmModelCategories extends GuideadmCkModelCategories{} }
