...
* @subpackage	Classes
*/
class GuideadmCkModelServicos extends GuideadmClassModelList
{
	/**
	* Default item layout.
	*
	...
	*/
	...
	{
		$item->section = JText::_('GUIDEADM') . ' - ' . JText::_('GUIDEADM_VIEW_SERVICO');
...
if (!class_exists('GuideadmModelServicos')){ class GuideadmModelServicos extends GuideadmCkModelServicos{} }
