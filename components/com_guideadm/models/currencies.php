...
* @subpackage	Classes
*/
class GuideadmCkModelCurrencies extends GuideadmClassModelList
{
	/**
	* Default item layout.
	*
	...
	*/
	...
	{
		$item->section = JText::_('GUIDEADM') . ' - ' . JText::_('GUIDEADM_VIEW_CURRENCY');
	...
	*/
	protected function prepareQuery(&$query)
	{
		...
		// ORDERING
		$orderCol = $this->getState('list.ordering', 'currency_id');
...
if (!class_exists('GuideadmModelCurrencies')){ class GuideadmModelCurrencies extends GuideadmCkModelCurrencies{} }
