...
* @subpackage	Classes
*/
class GuideadmCkModelOperator extends GuideadmClassModelItem
{
	/**
	* View list alias
	*
	...
	*/
	public function getTable($type = 'operator', $prefix = 'GuideadmTable', $config = array())
	{
	...
	*/
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_guideadm.edit.operator.data', array());
...
if (!class_exists('GuideadmModelOperator')){ class GuideadmModelOperator extends GuideadmCkModelOperator{} }
