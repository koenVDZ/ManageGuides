...
* @subpackage	Classes
*/
class GuideadmCkModelSociallabels extends GuideadmClassModelList
{
	/**
	* Default item layout.
	*
	...
	*/
	...
	{
		$item->section = JText::_('GUIDEADM') . ' - ' . JText::_('GUIDEADM_VIEW_SOCIAL_LABELS_ITEM');
...
if (!class_exists('GuideadmModelSociallabels')){ class GuideadmModelSociallabels extends GuideadmCkModelSociallabels{} }
