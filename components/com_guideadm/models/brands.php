...
* @subpackage	Classes
*/
class GuideadmCkModelBrands extends GuideadmClassModelList
{
	/**
	* Default item layout.
	*
	...
	*/
	...
	{
		$item->section = JText::_('GUIDEADM') . ' - ' . JText::_('GUIDEADM_VIEW_BRANDS_ITEM');
...
if (!class_exists('GuideadmModelBrands')){ class GuideadmModelBrands extends GuideadmCkModelBrands{} }
