...
* @subpackage	Classes
*/
class GuideadmCkModelBusinesstypes extends GuideadmClassModelList
{
	/**
	* Default item layout.
	*
	...
	*/
	...
	{
		$item->section = JText::_('GUIDEADM') . ' - ' . JText::_('GUIDEADM_VIEW_BUSINESSTYPE');
...
if (!class_exists('GuideadmModelBusinesstypes')){ class GuideadmModelBusinesstypes extends GuideadmCkModelBusinesstypes{} }
