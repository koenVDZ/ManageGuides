...
*/
function GuideadmBuildRoute(&$query)
{
	// Fork system
	if (function_exists('GuideadmCkBuildRoute')) return GuideadmCkBuildRoute($query);
...
*/
function GuideadmParseRoute($segments)
{
	// Fork system
	if (function_exists('GuideadmCkParseRoute')) return GuideadmCkParseRoute($segments);
...
*/
function GuideadmParseSlug($slug, $model, $aliasKey)
{
	// Fork system
	if (function_exists('GuideadmCkParseSlug')) return GuideadmCkParseSlug($slug, $model, $aliasKey);
...
*/
function GuideadmBuildSlug($id, $model, $aliasKey)
{
	// Fork system
	if (function_exists('GuideadmCkBuildSlug')) return GuideadmCkBuildSlug($id, $model, $aliasKey);
...
*/
function GuideadmRouteConfig()
{
	// Fork system
	if (function_exists('GuideadmCkRouteConfig')) return GuideadmCkRouteConfig();
