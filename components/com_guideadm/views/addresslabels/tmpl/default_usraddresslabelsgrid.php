	...
	<table class='table' id='grid-addresslabels'>
		<thead>
			<tr>
				...
				<th style="text-align:left">
					<?php echo JHTML::_('grid.sort',  "GUIDEADM_FIELD_USER_NAME", '_created_by_.username', $listDirn, $listOrder ); ?>
				</th>

				<th style="text-align:right">
					<?php echo JHTML::_('grid.sort',  "GUIDEADM_FIELD_LABEL_LANGUAGE", '_language_.image', $listDirn, $listOrder ); ?>
				</th>
