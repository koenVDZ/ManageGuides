...
<div class="">
	<table class='table' id='grid-businesstypes'>
		<thead>
			<tr>
				...
				<th style="text-align:center">
					<?php echo JHTML::_('grid.sort',  "GUIDEADM_FIELD_ABR", 'a.type_code', $listDirn, $listOrder ); ?>
				</th>

				<th style="text-align:center">
					<?php echo JText::_("GUIDEADM_FIELD_TYPE_NAME"); ?>
				</th>

				<th style="text-align:right">
					<?php echo JHTML::_('grid.sort',  "GUIDEADM_FIELD_FLAG", '_country_id_language_.image', $listDirn, $listOrder ); ?>
				</th>

				<th style="text-align:center">
					<?php echo JHTML::_('grid.sort',  "GUIDEADM_FIELD_LANGUAGE_LANG_CODE", '_language_.lang_code', $listDirn, $listOrder ); ?>
				</th>

				<th style="text-align:center">
					<?php echo JText::_("GUIDEADM_FIELD_INFORMATION"); ?>
				</th>

				<th style="text-align:center">
					<?php echo JHTML::_('grid.sort',  "GUIDEADM_FIELD_CREATED_BY_NAME", '_created_by_.name', $listDirn, $listOrder ); ?>
				</th>
				...
				<th style="text-align:center">
					<?php echo JHTML::_('grid.sort',  "GUIDEADM_FIELD_MODIFIED_BY_NAME_1", '_modified_by_.name', $listDirn, $listOrder ); ?>
				</th>
		...
		for ($i=0, $n=count( $this->items ); $i < $n; $i++):
			...
			if (!isset($group_country_id_language) || ($row->_country_id_language != $group_country_id_language)):?>
			<tr>
				<th colspan="17" class='grid-group grid-group-1'>
					<span>
						<?php echo JDom::_('html.fly', array(
							'dataKey' => '_country_id_language_title',
							'dataObject' => $row
						));?>
					</span>
				</th>
			...
			<?php
			$group_country_id_language = $row->_country_id_language;
			$k = 0;
			endif; ?>
			<?php
			...
			<tr>
				<th colspan="17" class='grid-group grid-group-2'>
					<span>
						<?php echo JDom::_('html.fly', array(
			...
			<tr class="<?php echo "row$k"; ?>">
				...
				<td style="text-align:right">
					<?php echo JDom::_('html.fly', array(
						'dataKey' => '_country_id_language_image',
						'dataObject' => $row
					));?>
				</td>
