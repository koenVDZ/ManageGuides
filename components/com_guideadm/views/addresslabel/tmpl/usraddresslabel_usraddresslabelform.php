...
<?php $fieldSet = $this->form->getFieldset('usraddresslabel.usraddresslabelform');?>
<fieldset class="fieldsform form-horizontal">
	<legend><?php echo JText::_($fieldSets['usraddresslabel.usraddresslabelform']->label);?></legend>
