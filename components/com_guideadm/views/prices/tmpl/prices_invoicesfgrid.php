		...
		<thead>
			<tr>
				...
				<th style="text-align:center">
					<?php echo JHTML::_('grid.sort',  "GUIDEADM_FIELD_REMARK", 'a.remark', $listDirn, $listOrder ); ?>
				</th>
				...
				<th style="text-align:center">
					<?php echo JHTML::_('grid.sort',  "GUIDEADM_FIELD_REMUNERATION", 'a.remuneration', $listDirn, $listOrder ); ?>
				</th>

				<th style="text-align:right">
					<?php echo JHTML::_('grid.sort',  "GUIDEADM_FIELD_RATE_A", 'a.coordination_fee', $listDirn, $listOrder ); ?>
				</th>

				<th style="text-align:right">
					<?php echo JHTML::_('grid.sort',  "GUIDEADM_FIELD_RATE_B", 'a.optional', $listDirn, $listOrder ); ?>
				</th>

				<th style="text-align:right">
					<?php echo JHTML::_('grid.sort',  "GUIDEADM_FIELD_RATE_C", 'a.extra_hour_day', $listDirn, $listOrder ); ?>
				</th>

				<th style="text-align:right">
					<?php echo JHTML::_('grid.sort',  "GUIDEADM_FIELD_RATE_D", 'a.extra_hour_night', $listDirn, $listOrder ); ?>
				</th>
				...
				<td>
					<div class="btn-group">
						<?php echo JDom::_('html.grid.task', array(
							'label' => 'GUIDEADM_JTOOLBAR_NEW_PERIOD',
							'num' => $i,
							'task' => 'price.custom'
						));?>
					</div>
