...
* @subpackage	Classes
*/
class GuidemanCkModelDoclabelsitem extends GuidemanClassModelItem
{
	/**
	* View list alias
	*
	...
	*/
	public function getLayout()
	{
		...
		return $jinput->get('layout', 'usrdoclabel', 'STRING');
	}
	...
	*/
	public function getTable($type = 'doclabelsitem', $prefix = 'GuidemanTable', $config = array())
	{
	...
	*/
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_guideman.edit.doclabelsitem.data', array());
		...
		if (empty($data)) {
			...
			if ($this->getState('doclabelsitem.id') == 0)
			{
				$jinput = JFactory::getApplication()->input;

				$data->id = 0;
				$data->doc_type_name = null;
				$data->doc_type_long = null;
	...
	* @param	integer	$pk	The primary id key of the doclabelsitem
	*
	* @return	void
	*/
...
if (!class_exists('GuidemanModelDoclabelsitem')){ class GuidemanModelDoclabelsitem extends GuidemanCkModelDoclabelsitem{} }
