...
* @subpackage	Classes
*/
class GuidemanCkModelAddresslabels extends GuidemanClassModelList
{
	/**
	* Default item layout.
	*
	* @var array
	*/
	public $itemDefaultLayout = 'usraddresslabel';
	...
	public function __construct($config = array())
	{
		...
		if (empty($config['filter_fields'])) {
			$config['filter_fields'] = array(
				...
				'_created_by_.username', 'created_by.username',
				'_language_.image', 'language.image',
	...
	*/
	...
	{
		$item->section = JText::_('GUIDEMAN') . ' - ' . JText::_('GUIDEMAN_VIEW_ADDRESS_LABEL');
	...
	*/
	protected function prepareQuery(&$query)
	{
		...
		// ORDERING
		$orderCol = $this->getState('list.ordering', 'type');
...
if (!class_exists('GuidemanModelAddresslabels')){ class GuidemanModelAddresslabels extends GuidemanCkModelAddresslabels{} }
