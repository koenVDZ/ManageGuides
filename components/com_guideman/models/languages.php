...
* @subpackage	Classes
*/
class GuidemanCkModelLanguages extends GuidemanClassModelList
{
	/**
	* Default item layout.
	*
	...
	*/
	...
	{
		$item->section = JText::_('GUIDEMAN') . ' - ' . JText::_('GUIDEMAN_VIEW_LANGUAGE');
...
if (!class_exists('GuidemanModelLanguages')){ class GuidemanModelLanguages extends GuidemanCkModelLanguages{} }
