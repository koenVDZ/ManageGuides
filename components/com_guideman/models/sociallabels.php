...
* @subpackage	Classes
*/
class GuidemanCkModelSociallabels extends GuidemanClassModelList
{
	/**
	* Default item layout.
	*
	...
	*/
	...
	{
		$item->section = JText::_('GUIDEMAN') . ' - ' . JText::_('GUIDEMAN_VIEW_SOCIAL_LABELS_ITEM');
...
if (!class_exists('GuidemanModelSociallabels')){ class GuidemanModelSociallabels extends GuidemanCkModelSociallabels{} }
