...
* @subpackage	Classes
*/
class GuidemanCkModelAddresslabel extends GuidemanClassModelItem
{
	/**
	* View list alias
	*
	...
	*/
	public function getLayout()
	{
		...
		return $jinput->get('layout', 'usraddresslabel', 'STRING');
	}
	...
	*/
	public function getTable($type = 'addresslabel', $prefix = 'GuidemanTable', $config = array())
	{
	...
	*/
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_guideman.edit.addresslabel.data', array());
...
if (!class_exists('GuidemanModelAddresslabel')){ class GuidemanModelAddresslabel extends GuidemanCkModelAddresslabel{} }
