...
* @subpackage	Classes
*/
class GuidemanCkModelActivepropertylists extends GuidemanClassModelList
{
	/**
	* Default item layout.
	*
	...
	*/
	...
	{
		$item->section = JText::_('GUIDEMAN') . ' - ' . JText::_('GUIDEMAN_VIEW_ACTIVEPROPERTYLIST');
...
if (!class_exists('GuidemanModelActivepropertylists')){ class GuidemanModelActivepropertylists extends GuidemanCkModelActivepropertylists{} }
