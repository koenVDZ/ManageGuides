...
* @subpackage	Classes
*/
class GuidemanCkModelCurrencies extends GuidemanClassModelList
{
	/**
	* Default item layout.
	*
	...
	*/
	...
	{
		$item->section = JText::_('GUIDEMAN') . ' - ' . JText::_('GUIDEMAN_VIEW_CURRENCY');
...
if (!class_exists('GuidemanModelCurrencies')){ class GuidemanModelCurrencies extends GuidemanCkModelCurrencies{} }
