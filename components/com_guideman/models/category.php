...
* @subpackage	Classes
*/
class GuidemanCkModelCategory extends GuidemanClassModelItem
{
	/**
	* View list alias
	*
	...
	*/
	public function getTable($type = 'category', $prefix = 'GuidemanTable', $config = array())
	{
	...
	*/
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_guideman.edit.category.data', array());
...
if (!class_exists('GuidemanModelCategory')){ class GuidemanModelCategory extends GuidemanCkModelCategory{} }
