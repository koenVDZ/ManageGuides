...
* @subpackage	Classes
*/
class GuidemanCkModelStates extends GuidemanClassModelList
{
	/**
	* Default item layout.
	*
	...
	*/
	...
	{
		$item->section = JText::_('GUIDEMAN') . ' - ' . JText::_('GUIDEMAN_VIEW_STATE');
...
if (!class_exists('GuidemanModelStates')){ class GuidemanModelStates extends GuidemanCkModelStates{} }
