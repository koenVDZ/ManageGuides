...
* @subpackage	Classes
*/
class GuidemanCkModelAccountsitem extends GuidemanClassModelItem
{
	/**
	* View list alias
	*
	...
	*/
	public function getLayout()
	{
		...
		return $jinput->get('layout', 'usrownbankaccount', 'STRING');
	}
	...
	*/
	public function getTable($type = 'accountsitem', $prefix = 'GuidemanTable', $config = array())
	{
	...
	*/
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_guideman.edit.accountsitem.data', array());
		...
		switch($this->getState('context', 'all'))
		{
			case 'layout.usrbankaccount':
				...
				$this->orm->select(array(
					...
					'bank_id.name',
					'bank_id.nationality',
					'bank_id.nationality.country_name',
					'iban',
					'swift',
					'user_id',
					'user_id.name'
...
if (!class_exists('GuidemanModelAccountsitem')){ class GuidemanModelAccountsitem extends GuidemanCkModelAccountsitem{} }
