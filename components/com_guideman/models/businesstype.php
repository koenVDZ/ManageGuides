...
* @subpackage	Classes
*/
class GuidemanCkModelBusinesstype extends GuidemanClassModelItem
{
	/**
	* View list alias
	*
	...
	*/
	public function delete(&$pks)
	{
		...
		//Integrity : Reset fk : business_type in contact
		$model = CkJModel::getInstance('contact', 'GuidemanModel');
		if (!$model->integrityReset('business_type', $pks))
		{
			JError::raiseWarning( 1302, JText::_("GUIDEMAN_ALERT_ERROR_ON_RESET_KEYS") );
			return false;
		}
	...
	*/
	public function getLayout()
	{
		...
		return $jinput->get('layout', 'usrbusinesstype', 'STRING');
	}
	...
	*/
	public function getTable($type = 'businesstype', $prefix = 'GuidemanTable', $config = array())
	{
	...
	*/
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_guideman.edit.businesstype.data', array());
		...
		if (empty($data)) {
			...
			if ($this->getState('businesstype.id') == 0)
			{
				$jinput = JFactory::getApplication()->input;
	...
	* @param	integer	$pk	The primary id key of the businesstype
	*
	* @return	void
	*/
...
if (!class_exists('GuidemanModelBusinesstype')){ class GuidemanModelBusinesstype extends GuidemanCkModelBusinesstype{} }
