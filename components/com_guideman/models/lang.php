...
* @subpackage	Classes
*/
class GuidemanCkModelLang extends GuidemanClassModelList
{
	/**
	* Default item layout.
	*
	...
	*/
	...
	{
		$item->section = JText::_('GUIDEMAN') . ' - ' . JText::_('GUIDEMAN_VIEW_LANGITEM');
...
if (!class_exists('GuidemanModelLang')){ class GuidemanModelLang extends GuidemanCkModelLang{} }
