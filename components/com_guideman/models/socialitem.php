...
* @subpackage	Classes
*/
class GuidemanCkModelSocialitem extends GuidemanClassModelItem
{
	/**
	* View list alias
	*
	...
	*/
	public function getTable($type = 'socialitem', $prefix = 'GuidemanTable', $config = array())
	{
	...
	*/
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_guideman.edit.socialitem.data', array());
...
if (!class_exists('GuidemanModelSocialitem')){ class GuidemanModelSocialitem extends GuidemanCkModelSocialitem{} }
