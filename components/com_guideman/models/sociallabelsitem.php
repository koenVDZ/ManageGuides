...
* @subpackage	Classes
*/
class GuidemanCkModelSociallabelsitem extends GuidemanClassModelItem
{
	/**
	...
	*/
	public function getTable($type = 'sociallabelsitem', $prefix = 'GuidemanTable', $config = array())
	{
	...
	*/
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_guideman.edit.sociallabelsitem.data', array());
...
if (!class_exists('GuidemanModelSociallabelsitem')){ class GuidemanModelSociallabelsitem extends GuidemanCkModelSociallabelsitem{} }
