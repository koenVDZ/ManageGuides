...
* @subpackage	Classes
*/
class GuidemanCkModelBrands extends GuidemanClassModelList
{
	/**
	* Default item layout.
	*
	...
	*/
	...
	{
		$item->section = JText::_('GUIDEMAN') . ' - ' . JText::_('GUIDEMAN_VIEW_BRANDS_ITEM');
...
if (!class_exists('GuidemanModelBrands')){ class GuidemanModelBrands extends GuidemanCkModelBrands{} }
