...
* @subpackage	Classes
*/
class GuidemanCkModelLanguage extends GuidemanClassModelItem
{
	/**
	* View list alias
	*
	...
	*/
	public function getTable($type = 'language', $prefix = 'GuidemanTable', $config = array())
	{
	...
	*/
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_guideman.edit.language.data', array());
...
if (!class_exists('GuidemanModelLanguage')){ class GuidemanModelLanguage extends GuidemanCkModelLanguage{} }
