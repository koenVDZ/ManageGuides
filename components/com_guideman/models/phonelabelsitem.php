...
* @subpackage	Classes
*/
class GuidemanCkModelPhonelabelsitem extends GuidemanClassModelItem
{
	/**
	* View list alias
	*
	...
	*/
	public function getLayout()
	{
		...
		return $jinput->get('layout', 'phonelabelsedit', 'STRING');
	}
	...
	*/
	public function getTable($type = 'phonelabelsitem', $prefix = 'GuidemanTable', $config = array())
	{
	...
	*/
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_guideman.edit.phonelabelsitem.data', array());
		...
		if (empty($data)) {
			...
			if ($this->getState('phonelabelsitem.id') == 0)
			{
				$jinput = JFactory::getApplication()->input;
	...
	* @param	integer	$pk	The primary id key of the phonelabelsitem
	*
	* @return	void
	*/
	...
	{
		//FROM : Main table
		$query->from('#__guideman_phonelabels AS a');
...
if (!class_exists('GuidemanModelPhonelabelsitem')){ class GuidemanModelPhonelabelsitem extends GuidemanCkModelPhonelabelsitem{} }
