...
* @subpackage	Classes
*/
class GuidemanCkModelCountry extends GuidemanClassModelItem
{
	/**
	...
	*/
	public function getLayout()
	{
		...
		return $jinput->get('layout', 'usrcountrydata', 'STRING');
	}
	...
	*/
	public function getTable($type = 'country', $prefix = 'GuidemanTable', $config = array())
	{
	...
	*/
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_guideman.edit.country.data', array());
		...
		if (empty($data)) {
			...
			if ($this->getState('country.id') == 0)
			{
				...
				$data->ordering = null;
				$data->published = 1;
				$data->_user_id_state_id = $jinput->get('filter_user_id_state_id', $this->getState('filter.user_id_state_id'), 'INT');
...
if (!class_exists('GuidemanModelCountry')){ class GuidemanModelCountry extends GuidemanCkModelCountry{} }
