...
* @subpackage	Classes
*/
class GuidemanCkModelServico extends GuidemanClassModelItem
{
	/**
	* View list alias
	*
	...
	*/
	public function getTable($type = 'servico', $prefix = 'GuidemanTable', $config = array())
	{
	...
	*/
	...
	{
		return parent::hit(array('servico'));
	}
	...
	*/
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_guideman.edit.servico.data', array());
...
if (!class_exists('GuidemanModelServico')){ class GuidemanModelServico extends GuidemanCkModelServico{} }
