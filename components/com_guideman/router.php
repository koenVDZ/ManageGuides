...
*/
function GuidemanBuildRoute(&$query)
{
	// Fork system
	if (function_exists('GuidemanCkBuildRoute')) return GuidemanCkBuildRoute($query);
...
*/
function GuidemanParseRoute($segments)
{
	// Fork system
	if (function_exists('GuidemanCkParseRoute')) return GuidemanCkParseRoute($segments);
...
*/
function GuidemanParseSlug($slug, $model, $aliasKey)
{
	// Fork system
	if (function_exists('GuidemanCkParseSlug')) return GuidemanCkParseSlug($slug, $model, $aliasKey);
...
*/
function GuidemanBuildSlug($id, $model, $aliasKey)
{
	// Fork system
	if (function_exists('GuidemanCkBuildSlug')) return GuidemanCkBuildSlug($id, $model, $aliasKey);
...
*/
function GuidemanRouteConfig()
{
	// Fork system
	if (function_exists('GuidemanCkRouteConfig')) return GuidemanCkRouteConfig();
