...
/**
* Guideman Businesstype Controller
*
* @package	Guideman
* @subpackage	Businesstype
*/
class GuidemanCkControllerBusinesstype extends GuidemanClassControllerItem
{
	/**
		...
		switch($this->getLayout() .'.'. $this->getTask())
		{
			case 'default.add':
				$this->applyRedirection($result, array(
					'stay',
					'com_guideman.businesstype.usrbusinesstype'
				), array(
	...
	*/
	public function cancel($key = null)
	{
		...
		switch($this->getLayout() .'.'. $this->getTask())
		{
			case 'usrbusinesstype.cancel':
				$this->applyRedirection($result, array(
					'stay',
					'com_guideman.businesstypes.default'
				), array(
					'cid[]' => null
				));
				break;
	...
	*/
	...
	{
		if ($default === 'edit')
			return 'usrbusinesstype';

		if ($default)
			return 'usrbusinesstype';

		$jinput = JFactory::getApplication()->input;
		return $jinput->get('layout', 'usrbusinesstype', 'CMD');
	}
...
if (!class_exists('GuidemanControllerBusinesstype')){ class GuidemanControllerBusinesstype extends GuidemanCkControllerBusinesstype{} }
