...
class GuidemanCkControllerService extends GuidemanClassControllerItem
{
	...
	*/
	protected function getLayout($default = null)
	{
		...
		return $jinput->get('layout', 'service', 'CMD');
	}
	...
	*/
	public function save($key = null, $urlVar = null)
	{
		...
		switch($this->getLayout() .'.'. $this->getTask())
		{
			...
			case 'service.save2copy':
				$this->applyRedirection($result, array(
					'stay',
					'com_guideman.service.service'
				), array(
					'cid[]' => $model->getState('service.id')
				));
				break;
	...
	*/
	public function toggle()
	{
		...
		$this->_result = $result = $this->_toggle(array(
			'toggle_private_tour' => 'private_tour',
			'toggle_entrance_fees' => 'entrance_fees',
			'toggle_kid_friendly' => 'kid_friendly',
			'toggle_disabled_friendly' => 'disabled_friendly'
		));
		$model = $this->getModel();
