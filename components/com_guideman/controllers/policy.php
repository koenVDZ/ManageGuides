...
/**
* Guideman Policy Controller
*
* @package	Guideman
* @subpackage	Policy
*/
class GuidemanCkControllerPolicy extends GuidemanClassControllerItem
{
	/**
	...
	*/
	protected function getLayout($default = null)
	{
		...
		return $jinput->get('layout', 'policy', 'CMD');
	}
	...
	*/
	public function save($key = null, $urlVar = null)
	{
		...
		switch($this->getLayout() .'.'. $this->getTask())
		{
			...
			case 'policy.save2copy':
				$this->applyRedirection($result, array(
					'stay',
					'com_guideman.policy.policy'
				), array(
					'cid[]' => $model->getState('policy.id')
				));
				break;
...
if (!class_exists('GuidemanControllerPolicy')){ class GuidemanControllerPolicy extends GuidemanCkControllerPolicy{} }
