...
* @subpackage	Contact
*/
class GuidemanCkControllerContact extends GuidemanClassControllerItem
{
	/**
	...
	*/
	protected function getLayout($default = null)
	{
		...
		return $jinput->get('layout', 'contact', 'CMD');
	}
...
if (!class_exists('GuidemanControllerContact')){ class GuidemanControllerContact extends GuidemanCkControllerContact{} }
