...
/**
* Guideman Servico Controller
*
* @package	Guideman
* @subpackage	Servico
*/
class GuidemanCkControllerServico extends GuidemanClassControllerItem
{
	/**
...
if (!class_exists('GuidemanControllerServico')){ class GuidemanControllerServico extends GuidemanCkControllerServico{} }
