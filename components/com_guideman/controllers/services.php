...
/**
* Guideman Services Controller
*
* @package	Guideman
* @subpackage	Services
*/
class GuidemanCkControllerServices extends GuidemanClassControllerList
{
	/**
...
if (!class_exists('GuidemanControllerServices')){ class GuidemanControllerServices extends GuidemanCkControllerServices{} }
