...
/**
* Guideman Contactlangitem Controller
*
* @package	Guideman
* @subpackage	Contactlangitem
*/
class GuidemanCkControllerContactlangitem extends GuidemanClassControllerItem
{
	/**
		...
		switch($this->getLayout() .'.'. $this->getTask())
		{
			case 'default.add':
				$this->applyRedirection($result, array(
					'stay',
					'com_guideman.contactlangitem.contactlangitem'
				), array(
...
if (!class_exists('GuidemanControllerContactlangitem')){ class GuidemanControllerContactlangitem extends GuidemanCkControllerContactlangitem{} }
