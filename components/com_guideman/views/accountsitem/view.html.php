...
*/
class GuidemanCkViewAccountsitem extends GuidemanClassView
{
	/**
	...
	* @var array
	*/
	protected $layouts = array('usrbankaccount', 'usrownbankaccount');
	...
	* @return	mixed	A string if successful, otherwise a JError object.
	*/
	protected function displayUsrownbankaccount($tpl = null)
	{
		// Initialiase variables.
		$this->model	= $model	= $this->getModel();
		$this->state	= $state	= $this->get('State');
		$this->params 	= $state->get('params');
		$state->set('context', 'layout.usrownbankaccount');
		$this->item		= $item		= $this->get('Item');
		...
		// Define the title
		$this->_prepareDocument(JText::_('GUIDEMAN_LAYOUT_BANK_ACCOUNT'), $this->item, 'user_id');
		...
		$model_bank_id = CkJModel::getInstance('Contacts', 'GuidemanModel');
...
if (!class_exists('GuidemanViewAccountsitem')){ class GuidemanViewAccountsitem extends GuidemanCkViewAccountsitem{} }
