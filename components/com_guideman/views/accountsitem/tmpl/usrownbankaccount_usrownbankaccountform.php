...
<?php $fieldSet = $this->form->getFieldset('usrownbankaccount.usrownbankaccountform');?>
<fieldset class="fieldsform form-horizontal">
	<legend><?php echo JText::_($fieldSets['usrownbankaccount.usrownbankaccountform']->label);?></legend>
