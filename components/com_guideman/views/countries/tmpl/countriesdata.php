...
<form action="<?php echo(JRoute::_("index.php")); ?>" method="post" name="adminForm" id="adminForm">
	<div class="row-fluid">
		<div id="contents" class="span12">
			...
			<!-- BRICK : usrcountriesdatagrid -->
			<?php echo $this->loadTemplate('usrcountriesdatagrid'); ?>
	...
	<?php 
		...
		'values' => array(
					...
					'layout' => $jinput->get('layout', 'countriesdata'),
					'boxchecked' => '0',
