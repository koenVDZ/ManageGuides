	...
	<table class='table' id='grid-services'>
		<thead>
			<tr>
				...
				<th style="text-align:center">
					<?php echo JHTML::_('grid.sort',  "GUIDEMAN_FIELD_INTERNAL_SERVICE_ID", 'a.internal_service_id', $listDirn, $listOrder ); ?>
				</th>
				...
				<th style="text-align:center">
					<?php echo JHTML::_('grid.sort',  "GUIDEMAN_FIELD_COUNTRY_ISO_2", 'country.iso_2', $listDirn, $listOrder ); ?>
				</th>

				<th style="text-align:center">
					<?php echo JHTML::_('grid.sort',  "GUIDEMAN_FIELD_COUNTRY_COUNTRY_NAME", 'country.country_name', $listDirn, $listOrder ); ?>
				</th>

				<th style="text-align:center">
					<?php echo JText::_("GUIDEMAN_FIELD_STATE_FLAG"); ?>
				</th>
				...
				<th style="text-align:center">
					<?php echo JHTML::_('grid.sort',  "GUIDEMAN_FIELD_ID", 'a.remunaration', $listDirn, $listOrder ); ?>
				</th>

				<th style="text-align:center">
					<?php echo JHTML::_('grid.sort',  "GUIDEMAN_FIELD_REMUNARATION", 'remunaration.name', $listDirn, $listOrder ); ?>
				</th>

				<th style="text-align:center">
					<?php echo JHTML::_('grid.sort',  "GUIDEMAN_FIELD_ID", 'a.costs', $listDirn, $listOrder ); ?>
				</th>

				<th style="text-align:center">
					<?php echo JHTML::_('grid.sort',  "GUIDEMAN_FIELD_SALES", 'costs.name', $listDirn, $listOrder ); ?>
				</th>
				...
				<th style="text-align:center">
					<?php echo JText::_("GUIDEMAN_FIELD_REMUNARATION_GROUPER"); ?>
				</th>

				<th style="text-align:center">
					<?php echo JText::_("GUIDEMAN_FIELD_REMUNARATION_NAME"); ?>
				</th>

				<th style="text-align:center">
					<?php echo JText::_("GUIDEMAN_FIELD_REMUNARATION_HOURLY_RATE"); ?>
				</th>

				<th style="text-align:center">
					<?php echo JText::_("GUIDEMAN_FIELD_REMUNARATION_MIN_TIME"); ?>
				</th>

				<th style="text-align:center">
					<?php echo JText::_("GUIDEMAN_FIELD_REMUNARATION_FROM_DATE"); ?>
				</th>

				<th style="text-align:center">
					<?php echo JText::_("GUIDEMAN_FIELD_REMUNARATION_UNTIL_DATE"); ?>
				</th>

				<th style="text-align:center">
					<?php echo JText::_("GUIDEMAN_FIELD_REMUNARATION_REMUNERATION"); ?>
				</th>

				<th style="text-align:center">
					<?php echo JText::_("GUIDEMAN_FIELD_REMUNARATION_REMARK"); ?>
				</th>

				<th style="text-align:center">
					<?php echo JText::_("GUIDEMAN_FIELD_REMUNARATION_PAX_01"); ?>
				</th>

				<th style="text-align:center">
					<?php echo JText::_("GUIDEMAN_FIELD_REMUNARATION_PAX_02"); ?>
				</th>
			</tr>
		</thead>
		<tbody>
			...
			<tr class="<?php echo "row$k"; ?>" sortable-group-id="<?php echo $row->company; ?>">
				...
				<td style="text-align:left">
					<?php echo JDom::_('html.fly.enum', array(
						...
						'dataObject' => $row,
						'labelKey' => 'text',
						'list' => GuidemanHelperEnum::_('services_activity_level'),
						'listKey' => 'value'
					));?>
				</td>
				...
				<td style="text-align:center">
					<?php echo JDom::_('html.fly', array(
						...
						'modalHeight' => 500,
						'modalWidth' => 600,
						'route' => array('view' => 'price','layout' => 'remuneration','cid[]' => $row->remunaration),
						'target' => 'modal'
					));?>
				</td>
				...
				<td style="text-align:center">
					<?php echo JDom::_('html.fly', array(
						...
						'modalHeight' => 500,
						'modalWidth' => 600,
						'route' => array('view' => 'price','layout' => 'price','cid[]' => $row->costs),
						'target' => 'modal'
					));?>
				</td>
