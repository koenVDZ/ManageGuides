	...
	<table class='table' id='grid-prices'>
		<thead>
			<tr>
				...
				<th style="text-align:center">
					<?php echo JHTML::_('grid.sort',  "GUIDEMAN_FIELD_MODIFIED_BY", 'modified_by.name', $listDirn, $listOrder ); ?>
				</th>
				...
				<th style="text-align:center">
					<?php echo JHTML::_('grid.sort',  "GUIDEMAN_FIELD_VIEWLEVEL", 'access.title', $listDirn, $listOrder ); ?>
				</th>
