	...
	<table class='table' id='grid-prices'>
		<thead>
			<tr>
				...
				<th style="text-align:center">
					<?php echo JText::_("GUIDEMAN_FIELD_CURRENCY"); ?>
				</th>
				...
				<th style="text-align:center">
					<?php echo JText::_("GUIDEMAN_FIELD_FROM"); ?>
				</th>

				<th style="text-align:center">
					<?php echo JText::_("GUIDEMAN_FIELD_UNTIL"); ?>
				</th>
				...
				<th style="text-align:center">
					<?php echo JText::_("GUIDEMAN_FIELD_OPTIONAL"); ?>
				</th>
		...
		for ($i=0, $n=count( $this->items ); $i < $n; $i++):
			...
			<tr>
				<th colspan="44" class='grid-group grid-group-1'>
					<span>
