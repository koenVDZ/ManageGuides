...
<form action="<?php echo(JRoute::_("index.php")); ?>" method="post" name="adminForm" id="adminForm">
	<div class="row-fluid">
		<div id="contents" class="span12">
			...
			<!-- BRICK : usrbusinesstypesgrid -->
			<?php echo $this->loadTemplate('usrbusinesstypesgrid'); ?>
	...
	<?php 
		...
		'values' => array(
					'view' => $jinput->get('view', 'businesstypes'),
