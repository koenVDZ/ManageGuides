	...
	<table class='table' id='grid-contactlang'>
		<thead>
			<tr>
				...
				<th style="text-align:right">
					<?php echo JHTML::_('grid.sort',  "GUIDEMAN_FIELD_FLAG", 'user_id.nationality.iso_2', $listDirn, $listOrder ); ?>
				</th>
				...
				<th style="text-align:left">
					<?php echo JHTML::_('grid.sort',  "GUIDEMAN_FIELD_ALIAS", 'user_id.alias', $listDirn, $listOrder ); ?>
				</th>

				<th style="text-align:center">
					<?php echo JHTML::_('grid.sort',  "GUIDEMAN_FIELD_ID", 'a.user_id', $listDirn, $listOrder ); ?>
				</th>

				<th style="text-align:center" width="1%">
					<?php echo JHTML::_('grid.sort',  "GUIDEMAN_FIELD_DG", 'user_id.driverguide', $listDirn, $listOrder ); ?>
				</th>

				<th style="text-align:center" width="1%">
					<?php echo JHTML::_('grid.sort',  "GUIDEMAN_FIELD_GENDER", 'user_id.gender', $listDirn, $listOrder ); ?>
				</th>

				<th style="text-align:right" width="20px">
					<?php echo JHTML::_('grid.sort',  "GUIDEMAN_FIELD_FLAG", 'language.flag', $listDirn, $listOrder ); ?>
				</th>
				...
				<th style="text-align:left">
					<?php echo JHTML::_('grid.sort',  "GUIDEMAN_FIELD_COUNTRY", 'user_id.country_id.country_name', $listDirn, $listOrder ); ?>
				</th>

				<th style="text-align:left">
					<?php echo JHTML::_('grid.sort',  "GUIDEMAN_FIELD_ABR", 'user_id.state_id.abbreviation', $listDirn, $listOrder ); ?>
				</th>

				<th style="text-align:left">
					<?php echo JHTML::_('grid.sort',  "GUIDEMAN_FIELD_STATE", 'user_id.state_id.state', $listDirn, $listOrder ); ?>
				</th>
				...
				<th class="badge badge-inverse" style="text-align:center" width="5%">
					<?php echo JHTML::_('grid.sort',  "GUIDEMAN_FIELD_ID", 'a.user_id', $listDirn, $listOrder ); ?>
				</th>

				<th style="text-align:center">
					<?php echo JText::_("GUIDEMAN_FIELD_CE"); ?>
				</th>
			</tr>
		</thead>
		<tbody>
		...
		for ($i=0, $n=count( $this->items ); $i < $n; $i++):
			...
			<tr class="<?php echo "row$k"; ?>">
				...
				<td style="text-align:right">
					<?php echo JDom::_('html.fly', array(
						'dataKey' => '_user_id_country_id_iso_2',
						'dataObject' => $row
					));?>
				</td>
				...
				<td style="text-align:left">
					<?php echo JDom::_('html.fly', array(
						'dataKey' => '_user_id_country_id_country_name',
						'dataObject' => $row
					));?>
				</td>
				...
				<td style="text-align:left">
					<?php echo JDom::_('html.fly', array(
						'dataKey' => '_user_id_state_id_abbreviation',
						'dataObject' => $row
					));?>
				</td>
				...
				<td class="badge badge-inverse" style="text-align:center" width="5%">
					<?php echo JDom::_('html.fly', array(
						'dataKey' => 'user_id',
						'dataObject' => $row,
				...
				<td style="text-align:center">
					<?php echo JDom::_('html.fly', array(
						'dataKey' => '_user_id_ce_details_id',
						'dataObject' => $row
					));?>
				</td>
			</tr>
