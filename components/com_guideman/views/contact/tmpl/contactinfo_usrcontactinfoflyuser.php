...
<fieldset class="fieldsfly fly-horizontal">
	...
	<div class="control-group field-surname">
    	<div class="control-label">
			<label><?php echo JText::_( "GUIDEMAN_FIELD_SURNAME" ); ?></label>
		</div>
	...
	<div class="control-group field-_country_id_country_name">
    	<div class="control-label">
			<label><?php echo JText::_( "GUIDEMAN_FIELD_AREA_COUNTRY" ); ?></label>
		</div>
	...
	<div class="control-group field-_state_id_state">
    	<div class="control-label">
			<label><?php echo JText::_( "GUIDEMAN_FIELD_AREA_STATE" ); ?></label>
		</div>
