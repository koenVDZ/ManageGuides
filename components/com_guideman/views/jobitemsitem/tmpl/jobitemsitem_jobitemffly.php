...
<fieldset class="fieldsfly fly-horizontal">
	...
	<div class="control-group field-_job_id_status">
    	<div class="control-label">
			<label><?php echo JText::_( "GUIDEMAN_FIELD_JOB_STATUS" ); ?></label>
		</div>
	...
	<div class="control-group field-_job_id_client_id_surname">
    	<div class="control-label">
			<label><?php echo JText::_( "GUIDEMAN_FIELD_CLIENT_FULL_NAME" ); ?></label>
		</div>
	...
	<div class="control-group field-_job_id_client_id_alias">
    	<div class="control-label">
			<label><?php echo JText::_( "GUIDEMAN_FIELD_CLIENT_ALIAS" ); ?></label>
		</div>
