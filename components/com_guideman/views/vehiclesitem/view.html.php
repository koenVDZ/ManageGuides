...
*/
class GuidemanCkViewVehiclesitem extends GuidemanClassView
{
	/**
	...
	* @var array
	*/
	protected $layouts = array('vehicleitem');
...
if (!class_exists('GuidemanViewVehiclesitem')){ class GuidemanViewVehiclesitem extends GuidemanCkViewVehiclesitem{} }
