	...
	<table class='table' id='grid-phonelabels'>
		<thead>
			<tr>
				...
				<th style="text-align:left">
					<?php echo JHTML::_('grid.sort',  "GUIDEMAN_FIELD_CREATED_BY", 'a.created_by', $listDirn, $listOrder ); ?>
				</th>
				...
				<th style="text-align:center">
					<?php echo JText::_("GUIDEMAN_FIELD_CREATED_BY_USERNAME"); ?>
				</th>

				<th style="text-align:right">
					<?php echo JText::_("GUIDEMAN_FIELD_LABEL_LANGUAGE"); ?>
				</th>

				<th style="text-align:left">
					<?php echo JHTML::_('grid.sort',  "GUIDEMAN_FIELD_LABEL_LANGUAGE", 'language.title', $listDirn, $listOrder ); ?>
				</th>
