	...
	<table class='table' id='grid-accounts'>
		<thead>
			<tr>
				...
				<th class="visible-desktop" style="text-align:center">
					<?php echo JHTML::_('grid.sort',  "GUIDEMAN_FIELD_ID", 'a.catid', $listDirn, $listOrder ); ?>
				</th>
				...
				<th class="flag-icon visible-desktop" style="text-align:right" width="25px">
					<?php echo JHTML::_('grid.sort',  "GUIDEMAN_FIELD_FLAG", '_bank_id_nationality_.iso_2', $listDirn, $listOrder ); ?>
				</th>
				...
				<th style="text-align:center">
					<?php echo JHTML::_('grid.sort',  "GUIDEMAN_FIELD_SWIFT_CODE", 'a.swift', $listDirn, $listOrder ); ?>
				</th>
		...
		for ($i=0, $n=count( $this->items ); $i < $n; $i++):
			...
			<tr class="<?php echo "row$k"; ?>">
				...
				<td class="flag-icon visible-desktop" style="text-align:right" width="25px">
					<?php echo JDom::_('html.fly', array(
