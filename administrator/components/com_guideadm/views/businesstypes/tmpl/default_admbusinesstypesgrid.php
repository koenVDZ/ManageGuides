		...
		<thead>
			<tr>
				...
				<th style="text-align:left">
					<?php echo JHTML::_('grid.sort',  "GUIDEADM_FIELD_TYPE_CODE", 'a.type_code', $listDirn, $listOrder ); ?>
				</th>

				<th style="text-align:left">
					<?php echo JHTML::_('grid.sort',  "GUIDEADM_FIELD_TYPE_NAME", 'a.type_name', $listDirn, $listOrder ); ?>
				</th>
				...
				<th style="text-align:left">
					<?php echo JHTML::_('grid.sort',  "GUIDEADM_FIELD_MODIFICATION_DATA", 'a.modification_date', $listDirn, $listOrder ); ?>
				</th>
