...
<form action="<?php echo(JRoute::_("index.php")); ?>" method="post" name="adminForm" id="adminForm">
	<div class="row-fluid guideadm">
		<div id="sidebar" class="span2">
			...
			<div class = "nav-filters">
				<!-- BRICK : admoperatorsfilters -->
				<?php if ($this->canDo->get('core.edit.state')): ?>
					<?php echo $this->filters['filter_published']->input;?>
				<?php endif; ?>

				<hr class="hr-condensed">
				<?php echo $this->filters['filter_contact_id']->input;?>
				<hr class="hr-condensed">
		...
		<div id="contents" class="span10">
			...
			<!-- BRICK : admoperatorsgrid -->
			<?php echo $this->loadTemplate('admoperatorsgrid'); ?>
	...
	<?php 
		...
		'values' => array(
					'view' => $jinput->get('view', 'operators'),
