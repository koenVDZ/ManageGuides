...
*/
class GuideadmCkViewDoclabels extends GuideadmClassView
{
	/**
	...
	*/
	...
	/**
	* Execute and display a template : Doc Labels
	*
	* @access	protected
	...
	*/
	protected function displayDefault($tpl = null)
	{
		...
		$this->menu = GuideadmHelper::addSubmenu('doclabels', 'default');
		$lists = array();
		$this->lists = &$lists;

		// Define the title
		$this->_prepareDocument(JText::_('GUIDEADM_LAYOUT_DOC_LABELS'));
		...
		// Toolbar
		JToolBarHelper::title(JText::_('GUIDEADM_LAYOUT_DOC_LABELS'), 'list');

		// New
		if ($model->canCreate())
			JToolBarHelper::addNew('doclabelsitem.add', "GUIDEADM_JTOOLBAR_NEW");

		// Edit
		if ($model->canEdit())
			JToolBarHelper::editList('doclabelsitem.edit', "GUIDEADM_JTOOLBAR_EDIT");

		// Delete
		if ($model->canDelete())
			JToolBarHelper::deleteList(JText::_('GUIDEADM_JTOOLBAR_ARE_YOU_SURE_TO_DELETE'), 'doclabelsitem.delete', "GUIDEADM_JTOOLBAR_DELETE");
		...
		if ($model->canEditState())
			JToolBarHelper::publishList('doclabels.publish', "GUIDEADM_JTOOLBAR_PUBLISH");

		// Unpublish
		if ($model->canEditState())
			JToolBarHelper::unpublishList('doclabels.unpublish', "GUIDEADM_JTOOLBAR_UNPUBLISH");

		// Trash
		if ($model->canEditState())
			JToolBarHelper::trash('doclabels.trash', "GUIDEADM_JTOOLBAR_TRASH");

		// Archive
		if ($model->canEditState())
			JToolBarHelper::archiveList('doclabels.archive', "GUIDEADM_JTOOLBAR_ARCHIVE");
	}
	...
	*/
	protected function displayModal($tpl = null)
	{
		...
		$this->menu = GuideadmHelper::addSubmenu('doclabels', 'modal');
		$lists = array();
		$this->lists = &$lists;
	...
	*/
	protected function getSortFields($layout = null)
	{
		return array(
			...
			'doc_type_name' => JText::_('GUIDEADM_FIELD_DOC_TYPE_NAME'),
			'doc_type_long' => JText::_('GUIDEADM_FIELD_DOC_TYPE_LONG'),
...
if (!class_exists('GuideadmViewDoclabels')){ class GuideadmViewDoclabels extends GuideadmCkViewDoclabels{} }
