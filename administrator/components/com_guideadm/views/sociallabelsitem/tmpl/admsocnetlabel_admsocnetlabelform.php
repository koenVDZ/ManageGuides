...
<?php $fieldSet = $this->form->getFieldset('admsocnetlabel.admsocnetlabelform');?>
<fieldset class="fieldsform form-horizontal">
	<legend><?php echo JText::_($fieldSets['admsocnetlabel.admsocnetlabelform']->label);?></legend>

	<?php
	// JForms dynamic initialization (Cook Self Service proposal)
	$fieldSet['jform_logo']->jdomOptions = array(
