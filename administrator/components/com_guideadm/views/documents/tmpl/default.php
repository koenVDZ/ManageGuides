	...
	<div class="row-fluid guideadm">
		<div id="sidebar" class="span2">
			...
			<div class = "nav-filters">
				...
				<hr class="hr-condensed">
				<?php echo $this->filters['filter_label_id']->input;?>
				<hr class="hr-condensed">
				<?php echo $this->filters['filter_emission_date']->input;?>
				<hr class="hr-condensed">
				<?php echo $this->filters['filter_expiration_date']->input;?>
				<hr class="hr-condensed">
		...
		<div id="contents" class="span10">
			...
			<!-- BRICK : admdocumentsgrid -->
			<?php echo $this->loadTemplate('admdocumentsgrid'); ?>
