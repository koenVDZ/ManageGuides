...
<?php $fieldSet = $this->form->getFieldset('language.admlanguageform');?>
<fieldset class="fieldsform form-horizontal">
	<legend><?php echo JText::_($fieldSets['language.admlanguageform']->label);?></legend>
	...
	<?php
	// Short Name
	$field = $fieldSet['jform_short_name'];
	?>
	<div class="control-group <?php echo 'field-' . $field->id . $field->responsive; ?>">
		<div class="control-label">
			<?php echo $field->label; ?>
