		...
		<thead>
			<tr>
				...
				<th style="text-align:center">
					<?php echo JText::_("GUIDEADM_FIELD_ISO_2"); ?>
				</th>

				<th style="text-align:center">
					<?php echo JText::_("GUIDEADM_FIELD_ISO_3"); ?>
				</th>

				<th style="text-align:center">
					<?php echo JText::_("GUIDEADM_FIELD_UN_MEMBER"); ?>
				</th>
				...
				<th style="text-align:center">
					<?php echo JText::_("GUIDEADM_FIELD_CCTLD"); ?>
				</th>

				<th style="text-align:center">
					<?php echo JText::_("GUIDEADM_FIELD_POPULATION"); ?>
				</th>

				<th style="text-align:center">
					<?php echo JText::_("GUIDEADM_FIELD_TOTAL_AREA"); ?>
				</th>
				...
				<th style="text-align:center">
					<?php echo JText::_("GUIDEADM_FIELD_WATER_AREA"); ?>
				</th>
