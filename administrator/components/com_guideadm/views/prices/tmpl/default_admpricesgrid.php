	...
	<table class='table' id='grid-prices'>
		<thead>
			<tr>
				...
				<th style="text-align:center">
					<?php echo JText::_("GUIDEADM_FIELD_CURRENCY_CURRENCY_ID"); ?>
				</th>
				...
				<th style="text-align:center">
					<?php echo JText::_("GUIDEADM_FIELD_FROM_DATE"); ?>
				</th>

				<th style="text-align:center">
					<?php echo JText::_("GUIDEADM_FIELD_UNTIL_DATE"); ?>
				</th>
				...
				<th style="text-align:center">
					<?php echo JText::_("GUIDEADM_FIELD_OPTIONAL_1"); ?>
				</th>
