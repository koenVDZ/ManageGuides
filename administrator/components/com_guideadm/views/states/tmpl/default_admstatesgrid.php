		...
		<thead>
			<tr>
				...
				<th style="text-align:left">
					<?php echo JHTML::_('grid.sort',  "GUIDEADM_FIELD_STATE_PROVINCE", 'a.state', $listDirn, $listOrder ); ?>
				</th>

				<th style="text-align:center">
					<?php echo JHTML::_('grid.sort',  "GUIDEADM_FIELD_ABBREVIATION", 'a.abbreviation', $listDirn, $listOrder ); ?>
				</th>
