	...
	<div class="row-fluid guideadm">
		<div id="sidebar" class="span2">
			...
			<div class = "nav-filters">
				...
				<hr class="hr-condensed">
				<?php echo $this->filters['filter_label']->input;?>
				<hr class="hr-condensed">
				<?php echo $this->filters['filter_cdc']->input;?>
				<hr class="hr-condensed">
				<?php echo $this->filters['filter_operator_country_id']->input;?>
				<hr class="hr-condensed">
		...
		<div id="contents" class="span10">
			...
			<!-- BRICK : admphonesgrid -->
			<?php echo $this->loadTemplate('admphonesgrid'); ?>
