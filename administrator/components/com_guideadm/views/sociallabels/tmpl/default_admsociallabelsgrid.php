...
<div class="">
	<table class='table' id='grid-sociallabels'>
		<thead>
			<tr>
				...
				<th style="text-align:center">
					<?php echo JText::_("GUIDEADM_FIELD_LOGO"); ?>
				</th>

				<th style="text-align:center">
					<?php echo JText::_("GUIDEADM_FIELD_LINK"); ?>
				</th>

				<th style="text-align:center">
					<?php echo JText::_("GUIDEADM_FIELD_LANGUAGE_TITLE"); ?>
				</th>
