...
<?php $fieldSet = $this->form->getFieldset('admservice.admserviceform');?>
<fieldset class="fieldsform form-horizontal">
	<legend><?php echo JText::_($fieldSets['admservice.admserviceform']->label);?></legend>
	...
	$fieldSet['jform_country']->jdomOptions = array(
			'list' => $this->lists['fk']['country']
		);
