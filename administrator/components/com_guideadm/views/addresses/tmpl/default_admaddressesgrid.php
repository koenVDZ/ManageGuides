		...
		<thead>
			<tr>
				...
				<th style="text-align:center">
					<?php echo JText::_("GUIDEADM_FIELD_DEFAULT_ADDRESS"); ?>
				</th>

				<th style="text-align:center">
					<?php echo JHTML::_('grid.sort',  "GUIDEADM_FIELD_TYPE", 'address_label.type', $listDirn, $listOrder ); ?>
				</th>
				...
				<th style="text-align:left">
					<?php echo JHTML::_('grid.sort',  "GUIDEADM_FIELD_STATE", 'state_id.state', $listDirn, $listOrder ); ?>
				</th>

				<th style="text-align:left">
					<?php echo JText::_("GUIDEADM_FIELD_ADDRESS"); ?>
				</th>

				<th style="text-align:left">
					<?php echo JHTML::_('grid.sort',  "GUIDEADM_FIELD_SUBURB", 'a.suburb', $listDirn, $listOrder ); ?>
				</th>

				<th style="text-align:center">
					<?php echo JText::_("GUIDEADM_FIELD_ZIPCODE"); ?>
				</th>

				<th style="text-align:center">
					<?php echo JText::_("GUIDEADM_FIELD_CITY"); ?>
				</th>
				...
				<?php if ($model->canEditState()): ?>
				<th style="text-align:center" width="30px">
					<?php echo JHTML::_('grid.sort',  "GUIDEADM_FIELD_PUBLISHED", 'a.published', $listDirn, $listOrder ); ?>
				</th>
				<?php endif; ?>
