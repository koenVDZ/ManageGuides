...
/**
* Guideadm Vehiclesitem Controller
*
* @package	Guideadm
* @subpackage	Vehiclesitem
*/
class GuideadmCkControllerVehiclesitem extends GuideadmClassControllerItem
{
	/**
		...
		switch($this->getLayout() .'.'. $this->getTask())
		{
			case 'default.add':
				$this->applyRedirection($result, array(
					'stay',
					'com_guideadm.vehiclesitem.vehicle'
				), array(
	...
	*/
	protected function getLayout($default = null)
	{
		...
		return $jinput->get('layout', 'vehicle', 'CMD');
	}
...
if (!class_exists('GuideadmControllerVehiclesitem')){ class GuideadmControllerVehiclesitem extends GuideadmCkControllerVehiclesitem{} }
