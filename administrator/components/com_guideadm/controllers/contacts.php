...
/**
* Guideadm Contacts Controller
*
* @package	Guideadm
* @subpackage	Contacts
*/
class GuideadmCkControllerContacts extends GuideadmClassControllerList
{
	/**
...
if (!class_exists('GuideadmControllerContacts')){ class GuideadmControllerContacts extends GuideadmCkControllerContacts{} }
