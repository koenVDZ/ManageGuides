...
/**
* Guideadm Contactlang Controller
*
* @package	Guideadm
* @subpackage	Contactlang
*/
class GuideadmCkControllerContactlang extends GuideadmClassControllerList
{
	/**
...
if (!class_exists('GuideadmControllerContactlang')){ class GuideadmControllerContactlang extends GuideadmCkControllerContactlang{} }
