...
/**
* Guideadm Price Controller
*
* @package	Guideadm
* @subpackage	Price
*/
class GuideadmCkControllerPrice extends GuideadmClassControllerItem
{
	/**
...
if (!class_exists('GuideadmControllerPrice')){ class GuideadmControllerPrice extends GuideadmCkControllerPrice{} }
