...
/**
* Guideadm Service Controller
*
* @package	Guideadm
* @subpackage	Service
*/
class GuideadmCkControllerService extends GuideadmClassControllerItem
{
	/**
...
if (!class_exists('GuideadmControllerService')){ class GuideadmControllerService extends GuideadmCkControllerService{} }
