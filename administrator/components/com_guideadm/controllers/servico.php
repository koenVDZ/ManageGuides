...
/**
* Guideadm Servico Controller
*
* @package	Guideadm
* @subpackage	Servico
*/
class GuideadmCkControllerServico extends GuideadmClassControllerItem
{
	/**
	...
	*/
	protected function getLayout($default = null)
	{
		...
		return $jinput->get('layout', 'servico', 'CMD');
	}
...
if (!class_exists('GuideadmControllerServico')){ class GuideadmControllerServico extends GuideadmCkControllerServico{} }
