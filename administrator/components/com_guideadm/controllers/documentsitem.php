...
/**
* Guideadm Documentsitem Controller
*
* @package	Guideadm
* @subpackage	Documentsitem
*/
class GuideadmCkControllerDocumentsitem extends GuideadmClassControllerItem
{
	/**
		...
		switch($this->getLayout() .'.'. $this->getTask())
		{
			case 'default.add':
				$this->applyRedirection($result, array(
					'stay',
					'com_guideadm.documentsitem.document'
				), array(
	...
	public function cancel($key = null)
	{
		...
		switch($this->getLayout() .'.'. $this->getTask())
		{
			case 'document.cancel':
				$this->applyRedirection($result, array(
					'stay',
					'com_guideadm.documents.default'
				), array(
					'cid[]' => null
				));
				break;
		...
		switch($this->getLayout() .'.'. $this->getTask())
		{
			...
			case 'document.apply':
				$this->applyRedirection($result, array(
					...
					'cid[]' => $model->getState('documentsitem.id')
				));
				break;
...
if (!class_exists('GuideadmControllerDocumentsitem')){ class GuideadmControllerDocumentsitem extends GuideadmCkControllerDocumentsitem{} }
