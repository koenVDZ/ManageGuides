...
class GuideadmCkControllerPhonelabelsitem extends GuideadmClassControllerItem
{
		...
		switch($this->getLayout() .'.'. $this->getTask())
		{
			case 'default.add':
				$this->applyRedirection($result, array(
					'stay',
					'com_guideadm.phonelabelsitem.phonelabel'
				), array(
	...
	*/
	public function cancel($key = null)
	{
		...
		switch($this->getLayout() .'.'. $this->getTask())
		{
			case 'phonelabel.cancel':
				$this->applyRedirection($result, array(
					'stay',
					'com_guideadm.phonelabels.default'
				), array(
					'cid[]' => null
				));
				break;
	...
	*/
	protected function getLayout($default = null)
	{
		...
		return $jinput->get('layout', 'phonelabel', 'CMD');
	}
