...
/**
* Guideadm Policy Controller
*
* @package	Guideadm
* @subpackage	Policy
*/
class GuideadmCkControllerPolicy extends GuideadmClassControllerItem
{
	/**
...
if (!class_exists('GuideadmControllerPolicy')){ class GuideadmControllerPolicy extends GuideadmCkControllerPolicy{} }
