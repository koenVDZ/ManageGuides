...
/**
* Guideadm Jobsitem Controller
*
* @package	Guideadm
* @subpackage	Jobsitem
*/
class GuideadmCkControllerJobsitem extends GuideadmClassControllerItem
{
	/**
...
if (!class_exists('GuideadmControllerJobsitem')){ class GuideadmControllerJobsitem extends GuideadmCkControllerJobsitem{} }
