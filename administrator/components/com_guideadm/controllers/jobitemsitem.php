...
/**
* Guideadm Jobitemsitem Controller
*
* @package	Guideadm
* @subpackage	Jobitemsitem
*/
class GuideadmCkControllerJobitemsitem extends GuideadmClassControllerItem
{
	/**
		...
		switch($this->getLayout() .'.'. $this->getTask())
		{
			case 'default.add':
				$this->applyRedirection($result, array(
					'stay',
					'com_guideadm.jobitemsitem.jobitem'
				), array(
	...
	*/
	protected function getLayout($default = null)
	{
		...
		return $jinput->get('layout', 'jobitem', 'CMD');
	}
...
if (!class_exists('GuideadmControllerJobitemsitem')){ class GuideadmControllerJobitemsitem extends GuideadmCkControllerJobitemsitem{} }
