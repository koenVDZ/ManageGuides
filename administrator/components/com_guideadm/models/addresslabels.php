...
* @subpackage	Classes
*/
class GuideadmCkModelAddresslabels extends GuideadmClassModelList
{
	/**
	* Default item layout.
	*
	* @var array
	*/
	public $itemDefaultLayout = 'addresslabel';
...
if (!class_exists('GuideadmModelAddresslabels')){ class GuideadmModelAddresslabels extends GuideadmCkModelAddresslabels{} }
