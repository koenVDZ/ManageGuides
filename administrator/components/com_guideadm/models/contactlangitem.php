...
* @subpackage	Classes
*/
class GuideadmCkModelContactlangitem extends GuideadmClassModelItem
{
	/**
	* View list alias
	*
	...
	*/
	public function getLayout()
	{
		...
		return $jinput->get('layout', 'contactlangitem', 'STRING');
	}
	...
	*/
	public function getTable($type = 'contactlangitem', $prefix = 'GuideadmTable', $config = array())
	{
	...
	*/
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_guideadm.edit.contactlangitem.data', array());
...
if (!class_exists('GuideadmModelContactlangitem')){ class GuideadmModelContactlangitem extends GuideadmCkModelContactlangitem{} }
