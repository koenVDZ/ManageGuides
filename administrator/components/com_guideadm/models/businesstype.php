...
* @subpackage	Classes
*/
class GuideadmCkModelBusinesstype extends GuideadmClassModelItem
{
	/**
	* View list alias
	*
	...
	*/
	public function delete(&$pks)
	{
		...
		$model = CkJModel::getInstance('contact', 'GuideadmModel');
		if (!$model->integrityReset('business_type', $pks))
		{
			JError::raiseWarning( 1302, JText::_("GUIDEADM_ALERT_ERROR_ON_RESET_KEYS") );
			return false;
		}
	...
	*/
	public function getLayout()
	{
		...
		return $jinput->get('layout', 'businesstype', 'STRING');
	}
	...
	*/
	public function getTable($type = 'businesstype', $prefix = 'GuideadmTable', $config = array())
	{
	...
	*/
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_guideadm.edit.businesstype.data', array());
...
if (!class_exists('GuideadmModelBusinesstype')){ class GuideadmModelBusinesstype extends GuideadmCkModelBusinesstype{} }
