...
* @subpackage	Classes
*/
class GuideadmCkModelDoclabelsitem extends GuideadmClassModelItem
{
	/**
	* View list alias
	*
	...
	*/
	public function getLayout()
	{
		...
		return $jinput->get('layout', 'doclabel', 'STRING');
	}
	...
	*/
	public function getTable($type = 'doclabelsitem', $prefix = 'GuideadmTable', $config = array())
	{
	...
	*/
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_guideadm.edit.doclabelsitem.data', array());
...
if (!class_exists('GuideadmModelDoclabelsitem')){ class GuideadmModelDoclabelsitem extends GuideadmCkModelDoclabelsitem{} }
