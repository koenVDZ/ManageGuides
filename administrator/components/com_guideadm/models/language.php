...
* @subpackage	Classes
*/
class GuideadmCkModelLanguage extends GuideadmClassModelItem
{
	/**
	* View list alias
	*
	...
	*/
	public function getLayout()
	{
		...
		return $jinput->get('layout', 'language', 'STRING');
	}
	...
	*/
	public function getTable($type = 'language', $prefix = 'GuideadmTable', $config = array())
	{
	...
	*/
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_guideadm.edit.language.data', array());
		...
		if (empty($data)) {
			...
			if ($this->getState('language.id') == 0)
			{
				$jinput = JFactory::getApplication()->input;
	...
	* @param	integer	$pk	The primary id key of the language
	*
	* @return	void
	*/
...
if (!class_exists('GuideadmModelLanguage')){ class GuideadmModelLanguage extends GuideadmCkModelLanguage{} }
