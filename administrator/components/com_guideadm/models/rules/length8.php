...
* @subpackage	Form
*/
class GuideadmCkFormRuleLength8 extends GuideadmClassFormRule
{
	/**
...
if (!class_exists('JFormRuleLength8')){ class JFormRuleLength8 extends GuideadmCkFormRuleLength8{} }
