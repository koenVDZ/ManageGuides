...
* @subpackage	Form
*/
class GuideadmCkFormRulePercent extends GuideadmClassFormRule
{
	/**
...
if (!class_exists('JFormRulePercent')){ class JFormRulePercent extends GuideadmCkFormRulePercent{} }
