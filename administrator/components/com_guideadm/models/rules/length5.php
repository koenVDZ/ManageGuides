...
* @subpackage	Form
*/
class GuideadmCkFormRuleLength5 extends GuideadmClassFormRule
{
	/**
...
if (!class_exists('JFormRuleLength5')){ class JFormRuleLength5 extends GuideadmCkFormRuleLength5{} }
