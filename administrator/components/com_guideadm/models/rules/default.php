...
* @subpackage	Form
*/
class GuideadmCkFormRuleDefault extends GuideadmClassFormRule
{
	/**
...
if (!class_exists('JFormRuleDefault')){ class JFormRuleDefault extends GuideadmCkFormRuleDefault{} }
