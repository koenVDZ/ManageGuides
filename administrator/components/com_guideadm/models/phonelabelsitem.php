...
* @subpackage	Classes
*/
class GuideadmCkModelPhonelabelsitem extends GuideadmClassModelItem
{
	/**
	* View list alias
	*
	...
	*/
	public function getLayout()
	{
		...
		return $jinput->get('layout', 'phonelabel', 'STRING');
	}
	...
	*/
	public function getTable($type = 'phonelabelsitem', $prefix = 'GuideadmTable', $config = array())
	{
	...
	*/
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_guideadm.edit.phonelabelsitem.data', array());
...
if (!class_exists('GuideadmModelPhonelabelsitem')){ class GuideadmModelPhonelabelsitem extends GuideadmCkModelPhonelabelsitem{} }
