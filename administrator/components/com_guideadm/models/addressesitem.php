...
* @subpackage	Classes
*/
class GuideadmCkModelAddressesitem extends GuideadmClassModelItem
{
	/**
	* View list alias
	*
	...
	*/
	public function getLayout()
	{
		...
		return $jinput->get('layout', 'usersadress', 'STRING');
	}
	...
	*/
	public function getTable($type = 'addressesitem', $prefix = 'GuideadmTable', $config = array())
	{
	...
	*/
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_guideadm.edit.addressesitem.data', array());
...
if (!class_exists('GuideadmModelAddressesitem')){ class GuideadmModelAddressesitem extends GuideadmCkModelAddressesitem{} }
