...
* @subpackage	Classes
*/
class GuideadmCkModelPrice extends GuideadmClassModelItem
{
	/**
	* View list alias
	*
	...
	*/
	public function getLayout()
	{
		...
		return $jinput->get('layout', 'price', 'STRING');
	}
	...
	*/
	public function getTable($type = 'price', $prefix = 'GuideadmTable', $config = array())
	{
	...
	*/
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_guideadm.edit.price.data', array());
	...
	*/
	public function save($data)
	{
		...
		$data['min_time'] = GuideadmHelperDates::getSqlDate($data['min_time'], array('H:i'), true, 'USER_UTC');

		//Convert from a non-SQL formated date (from_date)
		$data['from_date'] = GuideadmHelperDates::getSqlDate($data['from_date'], array('d-m-Y'), true, 'USER_UTC');

		//Convert from a non-SQL formated date (until_date)
		$data['until_date'] = GuideadmHelperDates::getSqlDate($data['until_date'], array('d-m-Y'), true, 'USER_UTC');

		//Convert from a non-SQL formated date (night_shift)
		$data['night_shift'] = GuideadmHelperDates::getSqlDate($data['night_shift'], array('H:i'), true, 'USER_UTC');
...
if (!class_exists('GuideadmModelPrice')){ class GuideadmModelPrice extends GuideadmCkModelPrice{} }
