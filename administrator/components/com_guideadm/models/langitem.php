...
* @subpackage	Classes
*/
class GuideadmCkModelLangitem extends GuideadmClassModelItem
{
	/**
	* View list alias
	*
	...
	*/
	public function getLayout()
	{
		...
		return $jinput->get('layout', 'langitem', 'STRING');
	}
	...
	*/
	public function getTable($type = 'langitem', $prefix = 'GuideadmTable', $config = array())
	{
	...
	*/
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_guideadm.edit.langitem.data', array());
		...
		if (empty($data)) {
			...
			if ($this->getState('langitem.id') == 0)
			{
				$jinput = JFactory::getApplication()->input;
	...
	* @param	integer	$pk	The primary id key of the langitem
	*
	* @return	void
	*/
...
if (!class_exists('GuideadmModelLangitem')){ class GuideadmModelLangitem extends GuideadmCkModelLangitem{} }
