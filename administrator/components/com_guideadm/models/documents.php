...
* @subpackage	Classes
*/
class GuideadmCkModelDocuments extends GuideadmClassModelList
{
	/**
	* Default item layout.
	*
	* @var array
	*/
	public $itemDefaultLayout = 'document';
	...
	*/
	protected function getStoreId($id = '')
	{
		...
		$id	.= ':'.$this->getState('filter.emission_date');
		$id	.= ':'.$this->getState('filter.expiration_date');
	...
	*/
	protected function prepareQuery(&$query)
	{
		...
		// FILTER : Emission Date
		if($filter_emission_date = $this->getState('filter.emission_date'))
		{
			if ($filter_emission_date !== null){
				$this->addWhere("a.emission_date = " . $this->_db->Quote($filter_emission_date));
			}
		}

		// FILTER : Expiration Date
		if($filter_expiration_date = $this->getState('filter.expiration_date'))
		{
			if ($filter_expiration_date !== null){
				$this->addWhere("a.expiration_date = " . $this->_db->Quote($filter_expiration_date));
			}
		}
...
if (!class_exists('GuideadmModelDocuments')){ class GuideadmModelDocuments extends GuideadmCkModelDocuments{} }
