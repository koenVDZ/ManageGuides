...
* @subpackage	Classes
*/
class GuideadmCkModelVehicles extends GuideadmClassModelList
{
	/**
	* Default item layout.
	*
	* @var array
	*/
	public $itemDefaultLayout = 'vehicle';
...
if (!class_exists('GuideadmModelVehicles')){ class GuideadmModelVehicles extends GuideadmCkModelVehicles{} }
