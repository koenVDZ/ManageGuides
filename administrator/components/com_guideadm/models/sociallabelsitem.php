...
* @subpackage	Classes
*/
class GuideadmCkModelSociallabelsitem extends GuideadmClassModelItem
{
	/**
	...
	* @var array
	*/
	protected $fileFields = array('logo');
	...
	* @var string
	*/
	protected $view_item = 'sociallabelsitem';
	...
	* @var string
	*/
	protected $view_list = 'sociallabels';
	...
	*/
	public function getLayout()
	{
		...
		return $jinput->get('layout', 'sociallabel', 'STRING');
	}
	...
	*/
	public function getTable($type = 'sociallabelsitem', $prefix = 'GuideadmTable', $config = array())
	{
	...
	*/
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_guideadm.edit.sociallabelsitem.data', array());
		...
		if (empty($data)) {
			...
			if ($this->getState('sociallabelsitem.id') == 0)
			{
				$jinput = JFactory::getApplication()->input;
	...
	* @param	integer	$pk	The primary id key of the sociallabelsitem
	*
	* @return	void
	*/
	...
	{
		//FROM : Main table
		$query->from('#__guideman_sociallabels AS a');
...
if (!class_exists('GuideadmModelSociallabelsitem')){ class GuideadmModelSociallabelsitem extends GuideadmCkModelSociallabelsitem{} }
