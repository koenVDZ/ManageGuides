...
* @subpackage	Classes
*/
class GuideadmCkModelPhonesitem extends GuideadmClassModelItem
{
	/**
	* View list alias
	*
	...
	*/
	public function getLayout()
	{
		...
		return $jinput->get('layout', 'phone', 'STRING');
	}
	...
	*/
	public function getTable($type = 'phonesitem', $prefix = 'GuideadmTable', $config = array())
	{
	...
	*/
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_guideadm.edit.phonesitem.data', array());
...
if (!class_exists('GuideadmModelPhonesitem')){ class GuideadmModelPhonesitem extends GuideadmCkModelPhonesitem{} }
