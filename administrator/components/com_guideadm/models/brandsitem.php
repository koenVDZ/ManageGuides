...
* @subpackage	Classes
*/
class GuideadmCkModelBrandsitem extends GuideadmClassModelItem
{
	/**
	* View list alias
	*
	...
	*/
	public function getLayout()
	{
		...
		return $jinput->get('layout', 'brand', 'STRING');
	}
	...
	*/
	public function getTable($type = 'brandsitem', $prefix = 'GuideadmTable', $config = array())
	{
	...
	*/
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_guideadm.edit.brandsitem.data', array());
...
if (!class_exists('GuideadmModelBrandsitem')){ class GuideadmModelBrandsitem extends GuideadmCkModelBrandsitem{} }
