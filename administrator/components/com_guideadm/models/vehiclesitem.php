...
* @subpackage	Classes
*/
class GuideadmCkModelVehiclesitem extends GuideadmClassModelItem
{
	/**
	* View list alias
	*
	...
	*/
	public function getLayout()
	{
		...
		return $jinput->get('layout', 'vehicle', 'STRING');
	}
	...
	*/
	public function getTable($type = 'vehiclesitem', $prefix = 'GuideadmTable', $config = array())
	{
	...
	*/
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_guideadm.edit.vehiclesitem.data', array());
	...
	*/
	public function save($data)
	{
		...
		$data['year_of_build'] = GuideadmHelperDates::getSqlDate($data['year_of_build'], array('d-m-Y'), true, 'USER_UTC');
...
if (!class_exists('GuideadmModelVehiclesitem')){ class GuideadmModelVehiclesitem extends GuideadmCkModelVehiclesitem{} }
