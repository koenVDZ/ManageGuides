...
* @subpackage	Classes
*/
class GuideadmCkModelCategory extends GuideadmClassModelItem
{
	/**
	* View list alias
	*
	...
	*/
	public function getTable($type = 'category', $prefix = 'GuideadmTable', $config = array())
	{
	...
	*/
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_guideadm.edit.category.data', array());
...
if (!class_exists('GuideadmModelCategory')){ class GuideadmModelCategory extends GuideadmCkModelCategory{} }
