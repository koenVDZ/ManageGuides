...
* @subpackage	Classes
*/
class GuideadmCkModelService extends GuideadmClassModelItem
{
	/**
	...
	*/
	public function getLayout()
	{
		...
		return $jinput->get('layout', 'service', 'STRING');
	}
	...
	*/
	public function getTable($type = 'service', $prefix = 'GuideadmTable', $config = array())
	{
	...
	*/
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_guideadm.edit.service.data', array());
...
if (!class_exists('GuideadmModelService')){ class GuideadmModelService extends GuideadmCkModelService{} }
