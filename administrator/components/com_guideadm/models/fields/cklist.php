...
* @subpackage	Form
*/
class GuideadmCkFormFieldCklist extends GuideadmClassFormField
{
	/**
	* The form field type.
	*
...
if (!class_exists('JFormFieldCklist')){ class JFormFieldCklist extends GuideadmCkFormFieldCklist{} }
