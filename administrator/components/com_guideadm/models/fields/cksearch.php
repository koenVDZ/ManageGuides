...
* @subpackage	Form
*/
class GuideadmCkFormFieldCksearch extends GuideadmClassFormField
{
	/**
	* The form field type.
	*
...
if (!class_exists('JFormFieldCksearch')){ class JFormFieldCksearch extends GuideadmCkFormFieldCksearch{} }
