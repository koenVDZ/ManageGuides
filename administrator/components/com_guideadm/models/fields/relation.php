...
* @subpackage	Form
*/
class GuideadmCkFormFieldRelation extends JFormFieldModel
{
	/**
	* The form field type.
	*
	...
	*/
	protected function getRelation()
	{
		...
		$model = CkJModel::getInstance($modelName, 'GuideadmModel');
...
if (!class_exists('JFormFieldRelation')){ class JFormFieldRelation extends GuideadmCkFormFieldRelation{} }
