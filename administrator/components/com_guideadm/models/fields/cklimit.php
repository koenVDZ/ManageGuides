...
* @subpackage	Form
*/
class GuideadmCkFormFieldCklimit extends GuideadmClassFormField
{
	/**
	* The form field type.
	*
...
if (!class_exists('JFormFieldCklimit')){ class JFormFieldCklimit extends GuideadmCkFormFieldCklimit{} }
