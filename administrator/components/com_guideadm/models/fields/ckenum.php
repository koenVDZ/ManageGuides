...
* @subpackage	Form
*/
class GuideadmCkFormFieldCkenum extends GuideadmClassFormField
{
	/**
	* The form field type.
	*
...
if (!class_exists('JFormFieldCkenum')){ class JFormFieldCkenum extends GuideadmCkFormFieldCkenum{} }
