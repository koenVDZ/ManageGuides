...
* @subpackage	Form
*/
class GuideadmCkFormFieldCkradio extends GuideadmClassFormField
{
	/**
	* The form field type.
	*
...
if (!class_exists('JFormFieldCkradio')){ class JFormFieldCkradio extends GuideadmCkFormFieldCkradio{} }
