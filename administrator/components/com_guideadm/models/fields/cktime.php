...
* @subpackage	Form
*/
class GuideadmCkFormFieldCktime extends GuideadmClassFormField
{
	/**
	* The form field type.
	*
...
if (!class_exists('JFormFieldCktime')){ class JFormFieldCktime extends GuideadmCkFormFieldCktime{} }
