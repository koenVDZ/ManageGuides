...
* @subpackage	Form
*/
class GuideadmCkFormFieldCkajax extends GuideadmClassFormField
{
	/**
	* The form field type.
	*
...
if (!class_exists('JFormFieldCkajax')){ class JFormFieldCkajax extends GuideadmCkFormFieldCkajax{} }
