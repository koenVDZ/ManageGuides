...
* @subpackage	Form
*/
class GuideadmCkFormFieldModel extends JFormFieldGroupedList
{
	/**
	* Foreign Key Filter. 
	*
	...
	*/
	protected function getGroups()
	{
		...
		$listGroups = GuideadmHelperForm::getElementGroups($this->element);
		...
		$items = GuideadmHelperForm::getItems($this);
		...
		foreach($items as $item)
		{
			...
			{
				$val = GuideadmHelper::parseValue($item, $labelKey);
				if ($val !== null)
	...
	*/
	protected function getOptions()
	{
		...
		if (!empty($items))
		foreach ($items as $item)
			$options[$item->$listKey] = GuideadmHelper::parseValue($item, $labelKey);
	...
	*/
	public function prepareModel(&$model)
	{
		...
		$groups = GuideadmHelperForm::getElementGroups($this->element);
...
if (!class_exists('JFormFieldModel')){ class JFormFieldModel extends GuideadmCkFormFieldModel{} }
