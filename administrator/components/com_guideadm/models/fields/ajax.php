...
* @subpackage	Form
*/
class GuideadmCkFormFieldAjax extends JFormField
{
	/**
	* Groups cache.
	*
	...
	protected function getConfig()
	{
		...
		switch($plugin)
		{
			...
			case 'field':
				...
				$config['groups'] = GuideadmHelperForm::getElementGroups($this->element);
	...
	*/
	protected function getModel($model = null)
	{
		...
		return GuideadmHelper::componentModel($model);
	}
...
if (!class_exists('JFormFieldAjax')){ class JFormFieldAjax extends GuideadmCkFormFieldAjax{} }
