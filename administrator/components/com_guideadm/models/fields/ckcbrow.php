...
* @subpackage	Form
*/
class GuideadmCkFormFieldCkcbrow extends GuideadmClassFormField
{
	/**
	* The form field type.
	*
...
if (!class_exists('JFormFieldCkcbrow')){ class JFormFieldCkcbrow extends GuideadmCkFormFieldCkcbrow{} }
