...
* @subpackage	Form
*/
class GuideadmCkFormFieldCktextarea extends GuideadmClassFormField
{
	/**
	* The form field type.
	*
...
if (!class_exists('JFormFieldCktextarea')){ class JFormFieldCktextarea extends GuideadmCkFormFieldCktextarea{} }
