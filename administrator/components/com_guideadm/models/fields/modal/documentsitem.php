...
* @subpackage	Form
*/
class GuideadmCkJFormFieldModal_Documentsitem extends GuideadmClassFormFieldModal
{
	/**
	...
	* @var string
	*/
	protected $_nullLabel = 'GUIDEADM_DATA_PICKER_SELECT_DOCUMENTS_ITEM';
...
if (!class_exists('JFormFieldModal_Documentsitem')){ class JFormFieldModal_Documentsitem extends GuideadmCkJFormFieldModal_Documentsitem{} }
