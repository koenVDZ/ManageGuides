...
* @subpackage	Form
*/
class GuideadmCkJFormFieldModal_Contact extends GuideadmClassFormFieldModal
{
	/**
	...
	* @var string
	*/
	protected $_nullLabel = 'GUIDEADM_DATA_PICKER_SELECT_CONTACT';
...
if (!class_exists('JFormFieldModal_Contact')){ class JFormFieldModal_Contact extends GuideadmCkJFormFieldModal_Contact{} }
