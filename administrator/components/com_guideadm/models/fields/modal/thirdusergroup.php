...
* @subpackage	Form
*/
class GuideadmCkJFormFieldModal_Thirdusergroup extends GuideadmClassFormFieldModal
{
	/**
	...
	* @var string
	*/
	protected $_nullLabel = 'GUIDEADM_DATA_PICKER_SELECT_USERGROUP';
...
if (!class_exists('JFormFieldModal_Thirdusergroup')){ class JFormFieldModal_Thirdusergroup extends GuideadmCkJFormFieldModal_Thirdusergroup{} }
