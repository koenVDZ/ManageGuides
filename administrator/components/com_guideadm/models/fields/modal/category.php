...
* @subpackage	Form
*/
class GuideadmCkJFormFieldModal_Category extends GuideadmClassFormFieldModal
{
	/**
	...
	* @var string
	*/
	protected $_nullLabel = 'GUIDEADM_DATA_PICKER_SELECT_CATEGORIES';
...
if (!class_exists('JFormFieldModal_Category')){ class JFormFieldModal_Category extends GuideadmCkJFormFieldModal_Category{} }
