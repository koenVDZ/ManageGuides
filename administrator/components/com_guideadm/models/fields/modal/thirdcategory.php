...
* @subpackage	Form
*/
class GuideadmCkJFormFieldModal_Thirdcategory extends GuideadmClassFormFieldModal
{
	/**
	...
	* @var string
	*/
	protected $_nullLabel = 'GUIDEADM_DATA_PICKER_SELECT_CATEGORY';
...
if (!class_exists('JFormFieldModal_Thirdcategory')){ class JFormFieldModal_Thirdcategory extends GuideadmCkJFormFieldModal_Thirdcategory{} }
