...
* @subpackage	Form
*/
class GuideadmCkJFormFieldModal_Price extends GuideadmClassFormFieldModal
{
	/**
	...
	* @var string
	*/
	protected $_nullLabel = 'GUIDEADM_DATA_PICKER_SELECT_PRICE';
...
if (!class_exists('JFormFieldModal_Price')){ class JFormFieldModal_Price extends GuideadmCkJFormFieldModal_Price{} }
