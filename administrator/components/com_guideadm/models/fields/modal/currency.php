...
* @subpackage	Form
*/
class GuideadmCkJFormFieldModal_Currency extends GuideadmClassFormFieldModal
{
	/**
	...
	* @var string
	*/
	protected $_nullLabel = 'GUIDEADM_DATA_PICKER_SELECT_CURRENCY';
...
if (!class_exists('JFormFieldModal_Currency')){ class JFormFieldModal_Currency extends GuideadmCkJFormFieldModal_Currency{} }
