...
* @subpackage	Form
*/
class GuideadmCkFormFieldCkcombo extends GuideadmClassFormField
{
	/**
	* The form field type.
	*
...
if (!class_exists('JFormFieldCkcombo')){ class JFormFieldCkcombo extends GuideadmCkFormFieldCkcombo{} }
