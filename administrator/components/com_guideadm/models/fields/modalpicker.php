...
* @subpackage	Form
*/
class GuideadmCkFormFieldModalpicker extends JFormField
{
	/**
	* Extension name.
	*
	...
	*/
	protected function getSelectedLabel()
	{
		...
		$selectedItem = GuideadmHelper::getData($model->getNameItem(), array(
...
if (!class_exists('JFormFieldModalpicker')){ class JFormFieldModalpicker extends GuideadmCkFormFieldModalpicker{} }
