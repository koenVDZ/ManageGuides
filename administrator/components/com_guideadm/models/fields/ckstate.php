...
* @subpackage	Form
*/
class GuideadmCkFormFieldCkstate extends GuideadmClassFormField
{
	/**
	* The form field type.
	*
...
if (!class_exists('JFormFieldCkstate')){ class JFormFieldCkstate extends GuideadmCkFormFieldCkstate{} }
