...
* @subpackage	Form
*/
class GuideadmCkFormFieldCkrules extends GuideadmClassFormField
{
	/**
	* The form field type.
	*
...
if (!class_exists('JFormFieldCkrules')){ class JFormFieldCkrules extends GuideadmCkFormFieldCkrules{} }
