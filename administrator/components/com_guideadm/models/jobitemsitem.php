...
* @subpackage	Classes
*/
class GuideadmCkModelJobitemsitem extends GuideadmClassModelItem
{
	/**
	* View list alias
	*
	...
	*/
	public function getLayout()
	{
		...
		return $jinput->get('layout', 'jobitem', 'STRING');
	}
	...
	*/
	public function getTable($type = 'jobitemsitem', $prefix = 'GuideadmTable', $config = array())
	{
	...
	*/
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_guideadm.edit.jobitemsitem.data', array());
	...
	*/
	public function save($data)
	{
		...
		$data['start_time'] = GuideadmHelperDates::getSqlDate($data['start_time'], array('H:i'), true, 'USER_UTC');
		...
		$data['end_time'] = GuideadmHelperDates::getSqlDate($data['end_time'], array('H:i'), true, 'USER_UTC');
...
if (!class_exists('GuideadmModelJobitemsitem')){ class GuideadmModelJobitemsitem extends GuideadmCkModelJobitemsitem{} }
