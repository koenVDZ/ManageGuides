...
* @subpackage	Classes
*/
class GuideadmCkModelSocialitem extends GuideadmClassModelItem
{
	/**
	* View list alias
	*
	...
	*/
	public function getLayout()
	{
		...
		return $jinput->get('layout', 'socialitem', 'STRING');
	}
	...
	*/
	public function getTable($type = 'socialitem', $prefix = 'GuideadmTable', $config = array())
	{
	...
	*/
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_guideadm.edit.socialitem.data', array());
		...
		if (empty($data)) {
			...
			if ($this->getState('socialitem.id') == 0)
			{
				$jinput = JFactory::getApplication()->input;
				...
				$data->labelid = $jinput->get('filter_labelid', $this->getState('filter.labelid'), 'INT');
				$data->name = null;
	...
	* @param	integer	$pk	The primary id key of the socialitem
	*
	* @return	void
	*/
...
if (!class_exists('GuideadmModelSocialitem')){ class GuideadmModelSocialitem extends GuideadmCkModelSocialitem{} }
