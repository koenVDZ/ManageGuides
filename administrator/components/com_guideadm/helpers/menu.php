...
defined('GUIDEADM_CPANEL_MAX_LENGTH') or define("GUIDEADM_CPANEL_MAX_LENGTH", null);
defined('GUIDEADM_CPANEL_ICON_SIZE') or define("GUIDEADM_CPANEL_ICON_SIZE", 48);
defined('GUIDEADM_CPANEL_BUTTON_WIDTH') or define("GUIDEADM_CPANEL_BUTTON_WIDTH", 100);
defined('GUIDEADM_CPANEL_BUTTON_HEIGHT') or define("GUIDEADM_CPANEL_BUTTON_HEIGHT", 100);
...
class GuideadmCkHelperMenu
{
	...
	*/
	protected static function getXml()
	{
		...
		{
			if ($client == 'admin')
				$xmlFileBase = JPATH_ADMIN_GUIDEADM;
			else
				$xmlFileBase = JPATH_SITE_GUIDEADM;
	...
	*/
	...
	{
		$maxLength = GUIDEADM_CPANEL_MAX_LENGTH;
		$iconSize = GUIDEADM_CPANEL_ICON_SIZE;
		$buttonWidth = GUIDEADM_CPANEL_BUTTON_WIDTH;
		$buttonHeight = GUIDEADM_CPANEL_BUTTON_HEIGHT;
...
if (!class_exists('GuideadmHelperMenu')){ class GuideadmHelperMenu extends GuideadmCkHelperMenu{} }
