...
* @subpackage	Class
*/
class GuideadmCkClassView extends CkJView
{
	/**
	...
	*/
	...
	{
		$this->addTemplatePath(JPATH_GUIDEADM . '/fork/views/' . $this->getName() . '/tmpl');
	}
...
if (!class_exists('GuideadmClassView')){ class GuideadmClassView extends GuideadmCkClassView{} }
