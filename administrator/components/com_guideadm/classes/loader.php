...
/**
* JLoader Class for Guideadm.
*
* @package	Guideadm
* @subpackage	Class
*/
class GuideadmCkClassLoader extends JLoader
{
	/**
	...
	*/
	public static function setup($enablePsr = true, $enablePrefixes = true, $enableClasses = true, $enableComponentLoader = false)
	{
		...
		if ($enableComponentLoader)
			spl_autoload_register(array('GuideadmClassLoader', 'load'));
	}
...
if (!class_exists('GuideadmClassLoader')){ class GuideadmClassLoader extends GuideadmCkClassLoader{} }
