...
/**
* ORM Class for Guideadm.
*
* @package	Guideadm
* @subpackage	Class
*/
class GuideadmCkClassModelOrm
{
	/**
	* Database.
	*
	...
	*/
	...
	{
		return new GuideadmClassModelOrm($model);
	}
...
if (!class_exists('GuideadmClassModelOrm')){ class GuideadmClassModelOrm extends GuideadmCkClassModelOrm{} }
