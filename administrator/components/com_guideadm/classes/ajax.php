...
/**
* Ajax Class for Guideadm.
*
* @package	Guideadm
* @subpackage	Class
*/
class GuideadmCkClassAjax extends JObject
{
	/**
	...
	*/
	public static function responseHook($options = array(), $version)
	{
		...
		switch(strtoupper($options['renderExceptions']))
		{
			...
			case 'HTML':
				$return->transaction->htmlExceptions = GuideadmClassView::renderMessages('HTML');
				break;

			case 'TEXT':
				$return->transaction->rawExceptions = GuideadmClassView::renderMessages('TEXT');
				break;
			...
			default:
				...
				else
				{
					...
					$return->transaction->exceptions = GuideadmClassView::renderMessages(null);
...
if (!class_exists('GuideadmClassAjax')){ class GuideadmClassAjax extends GuideadmCkClassAjax{} }
