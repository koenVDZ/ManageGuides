...
* @subpackage	
*/
class GuideadmCkClassControllerList extends JControllerAdmin
{
	/**
	...
	*/
	public function getModel($name = '', $prefix = 'GuideadmModel', $config = array('ignore_request' => true))
	{
		if (empty($name))
		{
...
if (!class_exists('GuideadmClassControllerList')){ class GuideadmClassControllerList extends GuideadmCkClassControllerList{} }
