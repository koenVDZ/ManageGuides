...
/**
* Script file of Guideadm component
*
* @package	Guideadm
* @subpackage	Installer
*/
class com_guideadmInstallerScript
{
	/**
	...
	*/
	...
	{
		$adapter->getParent()->setRedirectURL('index.php?option=com_guideadm');
	...
	*/
	public function postflight($type, JAdapterInstance $adapter)
	{
		...
		$txtComponent = JText::_('COM_GUIDEADM');
