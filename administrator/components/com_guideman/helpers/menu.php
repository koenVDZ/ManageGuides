...
defined('GUIDEMAN_CPANEL_MAX_LENGTH') or define("GUIDEMAN_CPANEL_MAX_LENGTH", null);
defined('GUIDEMAN_CPANEL_ICON_SIZE') or define("GUIDEMAN_CPANEL_ICON_SIZE", 48);
defined('GUIDEMAN_CPANEL_BUTTON_WIDTH') or define("GUIDEMAN_CPANEL_BUTTON_WIDTH", 100);
defined('GUIDEMAN_CPANEL_BUTTON_HEIGHT') or define("GUIDEMAN_CPANEL_BUTTON_HEIGHT", 100);
...
class GuidemanCkHelperMenu
{
	...
	*/
	protected static function getXml()
	{
		...
		{
			if ($client == 'admin')
				$xmlFileBase = JPATH_ADMIN_GUIDEMAN;
			else
				$xmlFileBase = JPATH_SITE_GUIDEMAN;
	...
	*/
	...
	{
		$maxLength = GUIDEMAN_CPANEL_MAX_LENGTH;
		$iconSize = GUIDEMAN_CPANEL_ICON_SIZE;
		$buttonWidth = GUIDEMAN_CPANEL_BUTTON_WIDTH;
		$buttonHeight = GUIDEMAN_CPANEL_BUTTON_HEIGHT;
...
if (!class_exists('GuidemanHelperMenu')){ class GuidemanHelperMenu extends GuidemanCkHelperMenu{} }
