...
-- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - >8 -
CREATE TABLE IF NOT EXISTS `#__guideman_servicos` (
	`id` BIGINT(20) UNSIGNED NOT NULL auto_increment,
	`internal_service_id` VARCHAR(25) ,
	`service_name` VARCHAR(255) ,
	`private_tour` TINYINT(11) ,
	`entrance_fees` TINYINT(11) ,
	...
	`country` BIGINT(20) UNSIGNED ,
	`state` BIGINT(20) UNSIGNED ,
	`kid_friendly` TINYINT(11) ,
	`kid_comment` TEXT ,
	`disabled_friendly` TINYINT(11) ,
	`disabled_comment` TEXT ,
...
-- - 8< - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
-- Create table : Activepropertylists
-- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - >8 -
CREATE TABLE IF NOT EXISTS `#__guideman_activepropertylists` (
	`id` BIGINT(20) UNSIGNED NOT NULL auto_increment,
	`EANHotelID` INT(11) ,
