...
/**
* HTML Raw View class for the Guideman component
*
* @package	Guideman
* @subpackage	Class
*/
class GuidemanCkClassViewRaw extends GuidemanClassView
{
	/**
	...
	*/
	public function outputField($name)
	{
		...
		JFormHelper::addFormPath(JPATH_GUIDEMAN .'/models/forms');
...
if (!class_exists('GuidemanClassViewRaw')){ class GuidemanClassViewRaw extends GuidemanCkClassViewRaw{} }
