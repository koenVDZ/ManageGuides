...
* @subpackage	Class
*/
class GuidemanCkClassView extends CkJView
{
	/**
	...
	*/
	...
	{
		$this->addTemplatePath(JPATH_GUIDEMAN . '/fork/views/' . $this->getName() . '/tmpl');
	}
...
if (!class_exists('GuidemanClassView')){ class GuidemanClassView extends GuidemanCkClassView{} }
