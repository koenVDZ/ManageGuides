...
/**
* ORM Class for Guideman.
*
* @package	Guideman
* @subpackage	Class
*/
class GuidemanCkClassModelOrm
{
	/**
	* Database.
	*
	...
	*/
	...
	{
		return new GuidemanClassModelOrm($model);
	}
...
if (!class_exists('GuidemanClassModelOrm')){ class GuidemanClassModelOrm extends GuidemanCkClassModelOrm{} }
