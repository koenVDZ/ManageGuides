...
/**
* Ajax Class for Guideman.
*
* @package	Guideman
* @subpackage	Class
*/
class GuidemanCkClassAjax extends JObject
{
	/**
	...
	*/
	public static function responseHook($options = array(), $version)
	{
		...
		switch(strtoupper($options['renderExceptions']))
		{
			...
			case 'HTML':
				$return->transaction->htmlExceptions = GuidemanClassView::renderMessages('HTML');
				break;

			case 'TEXT':
				$return->transaction->rawExceptions = GuidemanClassView::renderMessages('TEXT');
				break;
			...
			default:
				...
				else
				{
					...
					$return->transaction->exceptions = GuidemanClassView::renderMessages(null);
...
if (!class_exists('GuidemanClassAjax')){ class GuidemanClassAjax extends GuidemanCkClassAjax{} }
