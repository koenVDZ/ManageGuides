...
/**
* JLoader Class for Guideman.
*
* @package	Guideman
* @subpackage	Class
*/
class GuidemanCkClassLoader extends JLoader
{
	/**
	...
	*/
	public static function setup($enablePsr = true, $enablePrefixes = true, $enableClasses = true, $enableComponentLoader = false)
	{
		...
		if ($enableComponentLoader)
			spl_autoload_register(array('GuidemanClassLoader', 'load'));
	}
...
if (!class_exists('GuidemanClassLoader')){ class GuidemanClassLoader extends GuidemanCkClassLoader{} }
