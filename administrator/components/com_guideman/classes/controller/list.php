...
* @subpackage	
*/
class GuidemanCkClassControllerList extends JControllerAdmin
{
	/**
	...
	*/
	public function getModel($name = '', $prefix = 'GuidemanModel', $config = array('ignore_request' => true))
	{
		if (empty($name))
		{
...
if (!class_exists('GuidemanClassControllerList')){ class GuidemanClassControllerList extends GuidemanCkClassControllerList{} }
