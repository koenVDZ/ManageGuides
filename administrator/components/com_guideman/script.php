...
/**
* Script file of Guideman component
*
* @package	Guideman
* @subpackage	Installer
*/
class com_guidemanInstallerScript
{
	/**
	...
	*/
	...
	{
		$adapter->getParent()->setRedirectURL('index.php?option=com_guideman');
	...
	*/
	public function postflight($type, JAdapterInstance $adapter)
	{
		...
		$txtComponent = JText::_('COM_GUIDEMAN');
