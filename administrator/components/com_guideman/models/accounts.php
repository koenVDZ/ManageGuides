...
* @subpackage	Classes
*/
class GuidemanCkModelAccounts extends GuidemanClassModelList
{
	/**
	* Default item layout.
	*
...
if (!class_exists('GuidemanModelAccounts')){ class GuidemanModelAccounts extends GuidemanCkModelAccounts{} }
