...
* @subpackage	Classes
*/
class GuidemanCkModelOperators extends GuidemanClassModelList
{
	/**
	* Default item layout.
	*
...
if (!class_exists('GuidemanModelOperators')){ class GuidemanModelOperators extends GuidemanCkModelOperators{} }
