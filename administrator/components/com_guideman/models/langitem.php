...
* @subpackage	Classes
*/
class GuidemanCkModelLangitem extends GuidemanClassModelItem
{
	/**
	* View list alias
	*
	...
	*/
	public function getTable($type = 'langitem', $prefix = 'GuidemanTable', $config = array())
	{
	...
	*/
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_guideman.edit.langitem.data', array());
...
if (!class_exists('GuidemanModelLangitem')){ class GuidemanModelLangitem extends GuidemanCkModelLangitem{} }
