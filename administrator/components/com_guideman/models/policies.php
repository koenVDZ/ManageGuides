...
* @subpackage	Classes
*/
class GuidemanCkModelPolicies extends GuidemanClassModelList
{
	/**
	* Default item layout.
	*
	...
	public function __construct($config = array())
	{
		...
		if (empty($config['filter_fields'])) {
			$config['filter_fields'] = array(
				...
				'a.time_1', 'time_1',
				'a.percent_1', 'percent_1',
				'a.time_2', 'time_2',
				'a.percent_2', 'percent_2',
				'a.time_3', 'time_3',
				'a.percent_3', 'percent_3',
...
if (!class_exists('GuidemanModelPolicies')){ class GuidemanModelPolicies extends GuidemanCkModelPolicies{} }
