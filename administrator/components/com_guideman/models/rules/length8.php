...
* @subpackage	Form
*/
class GuidemanCkFormRuleLength8 extends GuidemanClassFormRule
{
	/**
...
if (!class_exists('JFormRuleLength8')){ class JFormRuleLength8 extends GuidemanCkFormRuleLength8{} }
