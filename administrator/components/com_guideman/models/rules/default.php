...
* @subpackage	Form
*/
class GuidemanCkFormRuleDefault extends GuidemanClassFormRule
{
	/**
...
if (!class_exists('JFormRuleDefault')){ class JFormRuleDefault extends GuidemanCkFormRuleDefault{} }
