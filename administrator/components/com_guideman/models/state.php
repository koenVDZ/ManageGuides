...
* @subpackage	Classes
*/
class GuidemanCkModelState extends GuidemanClassModelItem
{
	/**
	...
	*/
	public function getTable($type = 'state', $prefix = 'GuidemanTable', $config = array())
	{
	...
	*/
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_guideman.edit.state.data', array());
...
if (!class_exists('GuidemanModelState')){ class GuidemanModelState extends GuidemanCkModelState{} }
