...
* @subpackage	Classes
*/
class GuidemanCkModelPhonelabels extends GuidemanClassModelList
{
	/**
	* Default item layout.
	*
...
if (!class_exists('GuidemanModelPhonelabels')){ class GuidemanModelPhonelabels extends GuidemanCkModelPhonelabels{} }
