...
* @subpackage	Form
*/
class GuidemanCkFormFieldCkcombo extends GuidemanClassFormField
{
	/**
	* The form field type.
	*
...
if (!class_exists('JFormFieldCkcombo')){ class JFormFieldCkcombo extends GuidemanCkFormFieldCkcombo{} }
