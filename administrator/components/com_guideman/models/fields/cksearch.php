...
* @subpackage	Form
*/
class GuidemanCkFormFieldCksearch extends GuidemanClassFormField
{
	/**
	* The form field type.
	*
...
if (!class_exists('JFormFieldCksearch')){ class JFormFieldCksearch extends GuidemanCkFormFieldCksearch{} }
