...
* @subpackage	Form
*/
class GuidemanCkFormFieldModel extends JFormFieldGroupedList
{
	/**
	* Foreign Key Filter. 
	*
	...
	*/
	protected function getGroups()
	{
		...
		$listGroups = GuidemanHelperForm::getElementGroups($this->element);
		...
		$items = GuidemanHelperForm::getItems($this);
		...
		foreach($items as $item)
		{
			...
			{
				$val = GuidemanHelper::parseValue($item, $labelKey);
				if ($val !== null)
	...
	*/
	protected function getOptions()
	{
		...
		if (!empty($items))
		foreach ($items as $item)
			$options[$item->$listKey] = GuidemanHelper::parseValue($item, $labelKey);
	...
	*/
	public function prepareModel(&$model)
	{
		...
		$groups = GuidemanHelperForm::getElementGroups($this->element);
...
if (!class_exists('JFormFieldModel')){ class JFormFieldModel extends GuidemanCkFormFieldModel{} }
