...
* @subpackage	Form
*/
class GuidemanCkFormFieldCkcheckbox extends GuidemanClassFormField
{
	/**
	* The form field type.
	*
...
if (!class_exists('JFormFieldCkcheckbox')){ class JFormFieldCkcheckbox extends GuidemanCkFormFieldCkcheckbox{} }
