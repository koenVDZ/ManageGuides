...
* @subpackage	Form
*/
class GuidemanCkJFormFieldModal_Thirdviewlevel extends GuidemanClassFormFieldModal
{
	/**
	...
	* @var string
	*/
	protected $_nullLabel = 'GUIDEMAN_DATA_PICKER_SELECT_VIEWLEVEL';
...
if (!class_exists('JFormFieldModal_Thirdviewlevel')){ class JFormFieldModal_Thirdviewlevel extends GuidemanCkJFormFieldModal_Thirdviewlevel{} }
