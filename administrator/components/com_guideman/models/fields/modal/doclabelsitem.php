...
* @subpackage	Form
*/
class GuidemanCkJFormFieldModal_Doclabelsitem extends GuidemanClassFormFieldModal
{
	/**
	...
	* @var string
	*/
	protected $_nullLabel = 'GUIDEMAN_DATA_PICKER_SELECT_DOCLABELSITEM';
...
if (!class_exists('JFormFieldModal_Doclabelsitem')){ class JFormFieldModal_Doclabelsitem extends GuidemanCkJFormFieldModal_Doclabelsitem{} }
