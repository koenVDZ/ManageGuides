...
* @subpackage	Form
*/
class GuidemanCkJFormFieldModal_Thirdcategory extends GuidemanClassFormFieldModal
{
	/**
	...
	* @var string
	*/
	protected $_nullLabel = 'GUIDEMAN_DATA_PICKER_SELECT_CATEGORY';
...
if (!class_exists('JFormFieldModal_Thirdcategory')){ class JFormFieldModal_Thirdcategory extends GuidemanCkJFormFieldModal_Thirdcategory{} }
