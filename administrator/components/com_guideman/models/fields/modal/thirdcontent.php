...
* @subpackage	Form
*/
class GuidemanCkJFormFieldModal_Thirdcontent extends GuidemanClassFormFieldModal
{
	/**
	...
	* @var string
	*/
	protected $_nullLabel = 'GUIDEMAN_DATA_PICKER_SELECT_CONTENT';
...
if (!class_exists('JFormFieldModal_Thirdcontent')){ class JFormFieldModal_Thirdcontent extends GuidemanCkJFormFieldModal_Thirdcontent{} }
