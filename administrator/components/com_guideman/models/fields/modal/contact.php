...
* @subpackage	Form
*/
class GuidemanCkJFormFieldModal_Contact extends GuidemanClassFormFieldModal
{
	/**
	...
	* @var string
	*/
	protected $_nullLabel = 'GUIDEMAN_DATA_PICKER_SELECT_CONTACT';
...
if (!class_exists('JFormFieldModal_Contact')){ class JFormFieldModal_Contact extends GuidemanCkJFormFieldModal_Contact{} }
