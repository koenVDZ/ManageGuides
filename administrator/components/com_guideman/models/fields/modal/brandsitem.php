...
* @subpackage	Form
*/
class GuidemanCkJFormFieldModal_Brandsitem extends GuidemanClassFormFieldModal
{
	/**
	...
	* @var string
	*/
	protected $_nullLabel = 'GUIDEMAN_DATA_PICKER_SELECT_BRANDS_ITEM';
...
if (!class_exists('JFormFieldModal_Brandsitem')){ class JFormFieldModal_Brandsitem extends GuidemanCkJFormFieldModal_Brandsitem{} }
