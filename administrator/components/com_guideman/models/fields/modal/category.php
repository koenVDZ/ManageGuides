...
* @subpackage	Form
*/
class GuidemanCkJFormFieldModal_Category extends GuidemanClassFormFieldModal
{
	/**
	...
	* @var string
	*/
	protected $_nullLabel = 'GUIDEMAN_DATA_PICKER_SELECT_CATEGORIES';
...
if (!class_exists('JFormFieldModal_Category')){ class JFormFieldModal_Category extends GuidemanCkJFormFieldModal_Category{} }
