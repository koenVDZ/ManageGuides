...
* @subpackage	Form
*/
class GuidemanCkFormFieldCkbtngroup extends GuidemanClassFormField
{
	/**
	* The form field type.
	*
...
if (!class_exists('JFormFieldCkbtngroup')){ class JFormFieldCkbtngroup extends GuidemanCkFormFieldCkbtngroup{} }
