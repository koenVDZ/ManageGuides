...
* @subpackage	Form
*/
class GuidemanCkFormFieldRelation extends JFormFieldModel
{
	/**
	* The form field type.
	*
	...
	*/
	protected function getRelation()
	{
		...
		$model = CkJModel::getInstance($modelName, 'GuidemanModel');
...
if (!class_exists('JFormFieldRelation')){ class JFormFieldRelation extends GuidemanCkFormFieldRelation{} }
