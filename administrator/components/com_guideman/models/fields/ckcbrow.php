...
* @subpackage	Form
*/
class GuidemanCkFormFieldCkcbrow extends GuidemanClassFormField
{
	/**
	* The form field type.
	*
...
if (!class_exists('JFormFieldCkcbrow')){ class JFormFieldCkcbrow extends GuidemanCkFormFieldCkcbrow{} }
