...
* @subpackage	Form
*/
class GuidemanCkFormFieldCktextarea extends GuidemanClassFormField
{
	/**
	* The form field type.
	*
...
if (!class_exists('JFormFieldCktextarea')){ class JFormFieldCktextarea extends GuidemanCkFormFieldCktextarea{} }
