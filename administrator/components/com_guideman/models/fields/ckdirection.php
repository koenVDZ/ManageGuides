...
* @subpackage	Form
*/
class GuidemanCkFormFieldCkdirection extends GuidemanClassFormField
{
	/**
	* The form field type.
	*
...
if (!class_exists('JFormFieldCkdirection')){ class JFormFieldCkdirection extends GuidemanCkFormFieldCkdirection{} }
