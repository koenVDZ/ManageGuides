...
* @subpackage	Form
*/
class GuidemanCkFormFieldCkcolor extends GuidemanClassFormField
{
	/**
	* The form field type.
	*
...
if (!class_exists('JFormFieldCkcolor')){ class JFormFieldCkcolor extends GuidemanCkFormFieldCkcolor{} }
