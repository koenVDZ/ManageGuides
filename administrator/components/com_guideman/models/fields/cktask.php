...
* @subpackage	Form
*/
class GuidemanCkFormFieldCktask extends GuidemanClassFormField
{
	/**
	* The form field type.
	*
...
if (!class_exists('JFormFieldCktask')){ class JFormFieldCktask extends GuidemanCkFormFieldCktask{} }
