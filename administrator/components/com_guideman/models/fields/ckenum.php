...
* @subpackage	Form
*/
class GuidemanCkFormFieldCkenum extends GuidemanClassFormField
{
	/**
	* The form field type.
	*
...
if (!class_exists('JFormFieldCkenum')){ class JFormFieldCkenum extends GuidemanCkFormFieldCkenum{} }
