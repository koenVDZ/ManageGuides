...
* @subpackage	Form
*/
class GuidemanCkFormFieldCktime extends GuidemanClassFormField
{
	/**
	* The form field type.
	*
...
if (!class_exists('JFormFieldCktime')){ class JFormFieldCktime extends GuidemanCkFormFieldCktime{} }
