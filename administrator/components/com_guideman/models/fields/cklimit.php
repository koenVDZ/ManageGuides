...
* @subpackage	Form
*/
class GuidemanCkFormFieldCklimit extends GuidemanClassFormField
{
	/**
	* The form field type.
	*
...
if (!class_exists('JFormFieldCklimit')){ class JFormFieldCklimit extends GuidemanCkFormFieldCklimit{} }
