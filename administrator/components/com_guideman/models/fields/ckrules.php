...
* @subpackage	Form
*/
class GuidemanCkFormFieldCkrules extends GuidemanClassFormField
{
	/**
	* The form field type.
	*
...
if (!class_exists('JFormFieldCkrules')){ class JFormFieldCkrules extends GuidemanCkFormFieldCkrules{} }
