...
* @subpackage	Form
*/
class GuidemanCkFormFieldCkaccesslevel extends GuidemanClassFormField
{
	/**
	* The form field type.
	*
...
if (!class_exists('JFormFieldCkaccesslevel')){ class JFormFieldCkaccesslevel extends GuidemanCkFormFieldCkaccesslevel{} }
