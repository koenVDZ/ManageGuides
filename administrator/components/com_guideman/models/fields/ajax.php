...
* @subpackage	Form
*/
class GuidemanCkFormFieldAjax extends JFormField
{
	/**
	* Groups cache.
	*
	...
	protected function getConfig()
	{
		...
		switch($plugin)
		{
			...
			case 'field':
				...
				$config['groups'] = GuidemanHelperForm::getElementGroups($this->element);
	...
	*/
	protected function getModel($model = null)
	{
		...
		return GuidemanHelper::componentModel($model);
	}
...
if (!class_exists('JFormFieldAjax')){ class JFormFieldAjax extends GuidemanCkFormFieldAjax{} }
