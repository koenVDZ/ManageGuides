...
* @subpackage	Form
*/
class GuidemanCkFormFieldCklist extends GuidemanClassFormField
{
	/**
	* The form field type.
	*
...
if (!class_exists('JFormFieldCklist')){ class JFormFieldCklist extends GuidemanCkFormFieldCklist{} }
