...
* @subpackage	Form
*/
class GuidemanCkFormFieldCkfile extends GuidemanClassFormField
{
	/**
	* The form field type.
	*
...
if (!class_exists('JFormFieldCkfile')){ class JFormFieldCkfile extends GuidemanCkFormFieldCkfile{} }
