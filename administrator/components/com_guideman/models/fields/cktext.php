...
* @subpackage	Form
*/
class GuidemanCkFormFieldCktext extends GuidemanClassFormField
{
	/**
	* The form field type.
	*
...
if (!class_exists('JFormFieldCktext')){ class JFormFieldCktext extends GuidemanCkFormFieldCktext{} }
