...
* @subpackage	Classes
*/
class GuidemanCkModelPolicy extends GuidemanClassModelItem
{
	/**
	* View list alias
	*
	...
	*/
	public function getTable($type = 'policy', $prefix = 'GuidemanTable', $config = array())
	{
	...
	*/
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_guideman.edit.policy.data', array());
...
if (!class_exists('GuidemanModelPolicy')){ class GuidemanModelPolicy extends GuidemanCkModelPolicy{} }
