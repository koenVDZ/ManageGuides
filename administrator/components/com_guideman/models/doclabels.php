...
* @subpackage	Classes
*/
class GuidemanCkModelDoclabels extends GuidemanClassModelList
{
	/**
	* Default item layout.
	*
...
if (!class_exists('GuidemanModelDoclabels')){ class GuidemanModelDoclabels extends GuidemanCkModelDoclabels{} }
