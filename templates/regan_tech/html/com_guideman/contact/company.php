...
<form action="<?php echo(JRoute::_("index.php")); ?>" method="post" name="adminForm" id="adminForm" class='form-validate' enctype='multipart/form-data'>
	<div class="row-fluid">
		<div id="contents" class="span12">
			<!-- BRICK : usrcompanydetailtoolbar -->

			<?php echo $this->renderToolbar();?>
			<!-- BRICK : Detailed Company Information -->

			<?php echo $this->loadTemplate('usrcompanydetailform'); ?>
			<!-- BRICK : Settings -->

			<?php echo $this->loadTemplate('usrcompanysettings'); ?>
			<!-- BRICK : usrcompanydetailtoolbar -->
