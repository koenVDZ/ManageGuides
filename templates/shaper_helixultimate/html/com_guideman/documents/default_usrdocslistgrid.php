...
<div class="row-fluid">
	<table class='table table-sm' id='grid-documents'>
		<thead>
			<tr>
				...
				<th style="text-align:left">
					<?php echo JText::_("GUIDEMAN_FIELD_TYPE_OF_DOCUMENT"); ?>
				</th>
				...
				<th style="text-align:left">
					<?php echo JText::_("GUIDEMAN_FIELD_EMISSION_DATE"); ?>
				</th>

				<th style="text-align:left">
					<?php echo JText::_("GUIDEMAN_FIELD_EXPIRATION_DATE"); ?>
				</th>
