...
<div class="container-fluid">
				...
				<div>
					<h3>
						<i class="fal fa-user"></i>
							&#160<?php echo JText::_('GUIDEMAN_FIELDSET_GUIDE_DETAILED_INFORMATION') ?>
					</h3>
				</div>
			<?php endif; ?>
			<?php if ($var_catid == 25): ?>
				<div>
					<h3>
						<i class="fal fa-user"></i>&#160<?php echo JText::_('GUIDEMAN_FIELDSET_AGENCY_DETAILED_INFORMATION') ?>
					</h3>
				</div>
			<?php endif; ?>
			<?php if ($var_catid == 58): ?>
				<div>
					<h3>
						<i class="fal fa-user"></i>&#160<?php echo JText::_('GUIDEMAN_FIELDSET_DRIVER_DETAILED_INFORMATION') ?>
					</h3>
				</div>
			<?php endif; ?>
			<?php if ($var_catid == 99): ?>
				<div>
					<h3>
						<i class="fal fa-user"></i>&#160<?php echo JText::_('GUIDEMAN_FIELDSET_OPERATOR_DETAILED_INFORMATION') ?>
					</h3>
				</div>
			<?php endif; ?>
		</div>
	...
	<div class="row">
		<div class="col-6">
			<h2>
				<span class="flag-icon flag-icon-<?php echo strtolower(JDom::_('html.fly', array('dataKey' => '_nationality_iso_2','dataObject' => $this->item)));?>">
				</span>
	...
	<div class="row">
		...
		<div class="col-4">
			...
			<?php echo JDom::_('html.fly', array(
				'dataKey' => 'id',
				'dataObject' => $this->item,
				'domClass' => 'badge badge-pill badge-dark'
			));?>
			<?php echo JDom::_('html.fly', array(
				'dataKey' => 'alias',
				'dataObject' => $this->item,
				'domClass' => 'badge badge-secondary'
			));?>
				...
				if ($var_catid == 24): ?>
						...
						if ($driverguide){
							$driverguide = "<i class='fal fa-check-square' style='color:green'></i>";
								...
								$driverguide = "<i class='fal fa-times' style='color:red'></i>";
							}
					?>
