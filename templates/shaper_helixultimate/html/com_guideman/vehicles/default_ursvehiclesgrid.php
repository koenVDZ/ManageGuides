...
<div class="row">
	<table class='table table-sm' id='grid-vehicles'>
		<thead>
			<tr>
				...
				<th style="text-align:left">
					<?php echo JHTML::_('grid.sort',  "GUIDEMAN_FIELD_MAKE", '_brand_id_.name', $listDirn, $listOrder ); ?>
				</th>
		...
		for ($i=0, $n=count( $this->items ); $i < $n; $i++):
			...
			// KOEN 02/04/17 ?>
				...
				<td style="text-align:center" width="1%">
					<?php echo GuidemanHelperPermutations::AddCheckBox (JDom::_('html.fly', array('dataKey' => 'car_insurance','dataObject' => $row)));?>
				</td>

				<td style="text-align:center" width="1%">
					<?php echo GuidemanHelperPermutations::AddCheckBox (JDom::_('html.fly', array('dataKey' => 'insurance_for_third_parties','dataObject' => $row)));?>
				</td>
