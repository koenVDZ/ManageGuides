	...
	<div class="container">
		<div class="row">
			<div id="contents" class="span12">
				...
				<br>
				<!-- BRICK : useremunbygroupergrid -->
				<?php echo $this->loadTemplate('useremunbygroupergrid'); ?>
				<!-- BRICK : pagination -->
		...
		<?php
			...
			'values' => array(
						...
						'layout' => $jinput->get('layout', 'useremunbygrouper'),
						'boxchecked' => '0',
