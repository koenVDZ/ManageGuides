...
<div class="row">
	<table class='table table-sm' id='grid-addresses'>
		<thead>
			<tr>
				...
				<th scope="col" class="center hidden-xs" style="text-align:center" width="1%">
				...
				<th scope="col" style="text-align:center" width="1%">
					<?php echo JText::_("GUIDEMAN_FIELD_DEFAULT_ADDRESS"); ?>
				</th>

				<th scope="col" style="text-align:left">
					<?php echo JText::_("GUIDEMAN_FIELD_ADDRESS_TYPE"); ?>
				</th>

				<th scope="col" style="text-align:left">
					<?php echo JText::_("GUIDEMAN_FIELD_ADDRESS"); ?>
					<br/>
					<?php
					echo JText::_("GUIDEMAN_FIELD_ZIP") . " / " . JText::_("GUIDEMAN_FIELD_SUBURB");
					?>
					<br/>
					<?php echo JText::_("GUIDEMAN_FIELD_CITY"); ?>
				</th>

				<th scope="col" style="text-align:left">
					<?php echo JText::_("GUIDEMAN_FIELD_STATE", '_state_id_.state', $listDirn, $listOrder ); ?>
					<br/>
					<?php echo JText::_("GUIDEMAN_FIELD_COUNTRY", '_country_id_.country_name', $listDirn, $listOrder ); ?>
				</th>
		...
		for ($i=0, $n=count( $this->items ); $i < $n; $i++):
			...
			// KOEN 02/04/17
			$DefaultAddressBool = JDom::_('html.fly', array('dataKey' => 'default_address','dataObject' => $row));

			if ($DefaultAddressBool == 1 ) : ?>
			...
			// KOEN 02/04/17 ?>
				...
				<td style="text-align:center" width="1%">
					<?php echo GuidemanHelperPermutations::AddCheckBox ($DefaultAddressBool);?>
				</td>
