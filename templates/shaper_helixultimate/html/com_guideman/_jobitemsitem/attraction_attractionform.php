...
<?php $fieldSet = $this->form->getFieldset('attraction.attractionform');?>
<fieldset class="fieldsform form-horizontal">
	<legend><i class='fa fa-map-pin fa-border'></i><?php echo ' ' . JText::_($fieldSets['attraction.attractionform']->label);?></legend>
