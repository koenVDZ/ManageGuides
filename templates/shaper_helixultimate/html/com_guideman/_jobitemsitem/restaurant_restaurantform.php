...
<?php $fieldSet = $this->form->getFieldset('restaurant.restaurantform');?>
<fieldset class="fieldsform form-horizontal">
	<legend><i class='fa fa-cutlery fa-border'></i><?php echo ' ' . JText::_($fieldSets['restaurant.restaurantform']->label);?></legend>
